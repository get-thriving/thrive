...
def test_webui_lifecycle_local_login(page: Page, new_user: TestUser):
...
def test_webui_lifecycle_local_login_bad_user_name(
...
def test_webui_lifecycle_local_login_bad_password(page: Page, new_user: TestUser):
    page.goto("/app/workspace")
