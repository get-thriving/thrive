...
def test_webui_life_plan_aspect_acl(
    ...
    page.goto("/app/workspace/apps/life-plan/aspects")
    expect(page.locator(f"#aspect-{aspect.ref_id}")).to_have_count(0)

    page.goto(f"/app/workspace/apps/life-plan/aspects/{aspect.ref_id}")
...
def test_webui_life_plan_chapter_acl(
    ...
    page.goto(f"/app/workspace/apps/life-plan/chapters/{chapter.ref_id}")
    expect(page.locator("body")).to_contain_text(
        "You do not have the right access for this entity"
    )
...
def test_webui_life_plan_goal_acl(
    ...
    page.goto(f"/app/workspace/apps/life-plan/goals/{goal.ref_id}")
    expect(page.locator("body")).to_contain_text(
        "You do not have the right access for this entity"
    )
...
def test_webui_life_plan_milestone_acl(
    ...
    page.goto(f"/app/workspace/apps/life-plan/milestones/{milestone.ref_id}")
    expect(page.locator("body")).to_contain_text(
        "You do not have the right access for this entity"
    )
...
def test_webui_life_plan_vision_acl(
    ...
    page.goto(f"/app/workspace/apps/life-plan/visions/{vision.ref_id}")
    expect(page.locator("body")).to_contain_text(
        "You do not have the right access for this entity"
    )
...
def test_webui_life_plan_view_nothing(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan")
...
def test_webui_life_plan_visions_view_nothing(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan/visions")
...
def test_webui_life_plan_visions_create(page: Page) -> None:
    ...
    page.wait_for_url("**/app/workspace/apps/life-plan/visions/*")
...
def test_webui_life_plan_visions_mark_active(page: Page, create_vision_draft) -> None:
    ...
    page.wait_for_url("/app/workspace/apps/life-plan")
...
def test_webui_life_plan_visions_create_new_draft(
    ...
    page.goto(f"/app/workspace/apps/life-plan/visions/{old_vision.ref_id}")
    page.wait_for_selector("#leaf-panel")
    page.locator("#vision-actions button", has_text="Mark as Active").click()
    page.wait_for_url("/app/workspace/apps/life-plan")
...
def test_webui_life_plan_aspects_create(
    ...
    page.wait_for_url("**/app/workspace/apps/life-plan/aspects/*")
...
def test_webui_life_plan_aspects_update(page: Page, create_aspect) -> None:
    ...
    fill_after_hydration(
        page.locator('#leaflet-panel input[name="name"]'), "Aspect Lifecycle Updated"
    )
    page.locator("button[id='aspect-update']").click()
    page.wait_for_load_state("networkidle")

    # Leave and come back so the leaflet remounts from loader data, matching
    # the todo update test. Reloading the same leaflet URL can keep the
    # in-place defaultValue from the pre-save mount.
    page.goto("/app/workspace/apps/life-plan/aspects")
    page.goto(f"/app/workspace/apps/life-plan/aspects/{aspect.ref_id}")
    page.wait_for_selector("#leaflet-panel")
    expect(page.locator('#leaflet-panel input[name="name"]')).to_have_value(
        "Aspect Lifecycle Updated"
    )
...
def test_webui_life_plan_chapters_view_nothing(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan/chapters")
...
def test_webui_life_plan_chapters_create(
    ...
    page.wait_for_url("**/app/workspace/apps/life-plan/chapters/*")
...
def test_webui_life_plan_chapters_update(
    ...
    page.wait_for_selector("#leaf-panel")
    fill_after_hydration(
        page.locator('input[name="name"]'), "Chapter Lifecycle Updated"
    )
    page.locator("#chapter-properties button", has_text="Save").click()
    page.wait_for_url(f"/app/workspace/apps/life-plan/chapters/{chapter.ref_id}")
...
def test_webui_life_plan_goals_view_nothing(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan/goals")
...
def test_webui_life_plan_goals_create(
    ...
    page.wait_for_url("**/app/workspace/apps/life-plan/goals/*")
...
def test_webui_life_plan_goals_update(page: Page, create_aspect, create_goal) -> None:
    ...
    page.goto(f"/app/workspace/apps/life-plan/goals/{goal.ref_id}")
    page.wait_for_selector("#leaf-panel")
    fill_after_hydration(page.locator('input[name="name"]'), "Goal Lifecycle Updated")
...
def test_webui_life_plan_milestones_view_nothing(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan/milestones")
...
def test_webui_life_plan_milestones_create(
    ...
    page.wait_for_url("**/app/workspace/apps/life-plan/milestones/*")
...
def test_webui_life_plan_milestones_update(
    ...
    page.wait_for_selector("#leaf-panel")
    fill_after_hydration(
        page.locator('input[name="name"]'), "Milestone Lifecycle Updated"
    )
    page.locator("#milestone-properties button", has_text="Save").click()
    page.wait_for_url(f"/app/workspace/apps/life-plan/milestones/{milestone.ref_id}")
...
def test_webui_life_plan_settings_view(page: Page) -> None:
    page.goto("/app/workspace/apps/life-plan/settings")
