...
#USAGE flag "--webapi-storage-engine <engine>" default="sqlite" help="WebAPI primary storage (sqlite uses local Jupiter SQLite; postgres starts the sidecar and wires Postgres + Alembic; remote-postgres connects to an external Postgres URL)" {
#USAGE   choices "sqlite" "postgres" "remote-postgres"
#USAGE }
#USAGE flag "--webapi-postgres-url <url>" help="Postgres connection string for remote-postgres (postgresql://, postgres://, or postgresql+asyncpg://)"
