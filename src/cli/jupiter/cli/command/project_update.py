"""UseCase for updating projects."""

from jupiter.cli.config import JupiterLoggedInMutationCommand
from jupiter.core.apps.projects.use_case.update import (
    ProjectUpdateResult,
...
class ProjectUpdate(
    JupiterLoggedInMutationCommand[ProjectUpdateUseCase, ProjectUpdateResult]
):
