"""PostgreSQL based repository for the invocation record of mutation use cases."""
...
class PostgresMutationInvocationRecordRepository(
    PostgresRepository,
    MutationInvocationRecordRepository,
):
    """A PostgreSQL repository for mutation use cases invocation records."""
...
class PostgresMutationInvocationUnitOfWork(MutationInvocationUnitOfWork):
    """The PostgreSQL storage unit of work."""

    _mutation_invocation_record_repository: Final[
        PostgresMutationInvocationRecordRepository
    ]

    def __init__(
        self,
        mutation_invocation_record_repository: PostgresMutationInvocationRecordRepository,
    ) -> None:
        """Constructor."""
    ...
    def __enter__(self) -> "PostgresMutationInvocationUnitOfWork":
        """Enter the context."""
        return self
...
class PostgresMutationInvocationStorageEngine(MutationInvocationStorageEngine):
    """PostgreSQL based use case storage engine."""
    ...
    async def get_unit_of_work(self) -> AsyncIterator[MutationInvocationUnitOfWork]:
        ...
        async with self._sql_engine.begin() as connection:
            ...
            yield PostgresMutationInvocationUnitOfWork(
