...
A _Goal_ represents something meaningful you are working towards — a
long-term aspiration or outcome that may take months or years to achieve.
Goals are part of the [Life Plan](overview.md).
...
Goals can be nested. A top-level goal like _"Be healthy"_ can have child
goals such as _"Exercise regularly"_ and _"Eat well"_, which in turn can
...
Open the **Life Plan** section from the sidebar, then choose **Goals** from
the menu. Goals are displayed as a tree, reflecting their hierarchy.
