...
A _Project_ is a long-lived container for work. It acts as a label that
...
Projects represent the major ongoing areas of your life — things like
...
In most cases, a small number of projects (one to five) is enough. Projects
...
Projects can be nested within other projects, forming a tree. The maximum
...
Projects live inside the Life Plan. They are referenced by
...
Every task, habit, chore, and big plan can be tagged with a project.
