...
for ever, and will always be accessible.

It currently happens daily without any user intervention.

There is a log of all the runs, which shows you which entities werearchived too.

In the web app you can find reporting in the `Garbage Collect` left-hand side
tab, under _tools_. It lookssomething like this:
...
extra edits on a particular instance of a task, besidesmarking some entities as
archived.
