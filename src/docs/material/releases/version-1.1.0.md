...
* Setup a landing site at [get-thriving.com](https://get-thriving.com). The app
  itself lives at
  [app](https://app.get-thriving.com). And the docs at
  [docs](https://docs.get-thriving.com).  The site is hosted on Wix, and the
  docs are moved to render.io, same as the app.  Stoped using "readthedocs".
* Basics of being a more public thing: privacy policy, terms of service, contact
  forms,
