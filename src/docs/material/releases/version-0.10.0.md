...
Like [version 0.9.0](version-0.9.0.md), this launch includes a numbr of big
changes.They have to do with UX this time and how one interacts with Thrive via
Notion.
...
* Separation of recurring tasks into [habits](../concepts/habits.md) and
  ...
  each with their own behaviours. Habits can be repeated, while chores can be
  suspended during vacations, and  have activation intervals.
