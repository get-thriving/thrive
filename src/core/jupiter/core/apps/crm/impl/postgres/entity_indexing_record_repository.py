"""PostgreSQL persistence for :class:`CRMEntityIndexingRecordRepository`."""

from typing import Final, cast

from jupiter.core.apps.crm.entity_indexing_record import (
...
class PostgresCRMEntityIndexingRecordRepository(
    PostgresRecordRepository[CRMEntityIndexingRecord, tuple[EntityId, str, EntityId]],
    CRMEntityIndexingRecordRepository,
):
    """PostgreSQL table ``crm_entity_indexing_map``."""
