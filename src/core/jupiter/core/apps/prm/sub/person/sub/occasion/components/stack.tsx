...
import { sortOccasionsNaturally } from "#/core/apps/prm/sub/person/sub/occasion/root";
      ...
      {sortedOccasions.map((occasion) => {
        ...
        return (
          ...
          >
            {linksEnabled ? (
              <EntityLink
                to={`/app/workspace/apps/prm/persons/${occasion.person_ref_id}/occasions/${occasion.ref_id}`}
              >
                {content}
              </EntityLink>
            ) : (
