"""The SQLite based PRM repositories."""

from sqlite3 import IntegrityError
from typing import Final, Mapping, cast

from jupiter.core.apps.prm.sub.person_circle_links.root import (
    PersonCircleLink,
...
class SqlitePersonCircleLinkRepository(
    SqliteRecordRepository[PersonCircleLink, tuple[EntityId, EntityId, EntityId]],
    PersonCircleLinkRepository,
):
    """A SQLite repository for person-circle links."""
