...
@use_case_args
class TimePlanQuestionArchiveArgs(JupiterArchiveLeafSupportEntityArgs):
    """TimePlanQuestionArchive args."""
...
class TimePlanQuestionArchiveUseCase(
    JupiterArchiveLeafSupportEntityUseCase[TimePlanQuestionArchiveArgs, None]
):
    """Use case for archiving a time plan question."""
    ...
    async def _perform_transactional_mutation(
        ...
        args: TimePlanQuestionArchiveArgs,
    ) -> None:
        ...
        time_plan_question = time_plan_question.mark_archived(
