...
class TimePlanDomain(TrunkEntity):
    ...
    def update(
        ...
        planning_task_scheduling_params: UpdateAction[SchedulingParams],
        ...
        return self._new_version(
            ...
            generation_in_advance_days=final_generation_in_advance_days,
            planning_task_gen_params=final_planning_task_gen_params,
            planning_task_scheduling_params=planning_task_scheduling_params.or_else(
                self.planning_task_scheduling_params
            ),
