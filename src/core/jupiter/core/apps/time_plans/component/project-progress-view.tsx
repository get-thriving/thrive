...
import { ProjectProgressSummary } from "#/core/apps/time_plans/project-progress-summary";

interface ProjectProgressViewProps {
  summary: ProjectProgressSummary;
}

export function ProjectProgressView(props: ProjectProgressViewProps) {
    ...
    <TableContainer component={Paper}>
      <Table size="small">
        ...
        >
          ...
          <TableRow>
            <ValueAndPctCell value="Projects" align="left" />
            <ValueAndPctCell
