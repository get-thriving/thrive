...
import { TimePlanSourceTag } from "#/core/apps/time_plans/component/source-tag";
...
export function TimePlanCard(props: TimePlanCardProps) {
  ...
  const link =
    props.relativeToTimePlan !== undefined
      ? `/app/workspace/apps/time-plans/${props.relativeToTimePlan.ref_id}/add-from-current-time-plans/${timePlan.ref_id}`
      : `/app/workspace/apps/time-plans/${timePlan.ref_id}`;
  return (
    <EntityCard
