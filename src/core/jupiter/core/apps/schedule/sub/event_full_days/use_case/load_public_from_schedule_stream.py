"""Guest readonly use case for loading a schedule full days event via a published stream."""
...
from jupiter.core.apps.schedule.sub.event_full_days.service.load import (
...
@use_case_args
class ScheduleEventFullDaysLoadPublicFromScheduleStreamArgs(UseCaseArgsBase):
...
class ScheduleEventFullDaysLoadPublicFromScheduleStreamUseCase(
    JupiterGuestReadonlyUseCase[
    ...
    async def _execute(
        ...
        args: ScheduleEventFullDaysLoadPublicFromScheduleStreamArgs,
    ) -> ScheduleEventFullDaysLoadResult:
