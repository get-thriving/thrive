"""Guest readonly use case for loading a published schedule event in day."""
...
from jupiter.core.apps.schedule.sub.event_in_day.service.load import (
...
@use_case_args
class ScheduleEventInDayLoadPublicArgs(UseCaseArgsBase):
    """ScheduleEventInDayLoadPublic args."""

    external_id: PublishExternalId


class ScheduleEventInDayLoadPublicUseCase(
    JupiterGuestReadonlyUseCase[
        ScheduleEventInDayLoadPublicArgs, ScheduleEventInDayLoadResult
    ]
):
    ...
    async def _execute(
        ...
        args: ScheduleEventInDayLoadPublicArgs,
    ) -> ScheduleEventInDayLoadResult:
