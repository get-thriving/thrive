"""Use case for removing a milestone."""
...
from jupiter.core.apps.life_plan.sub.milestones.service.unlink_entities import (
...
class MilestoneRemoveUseCase(
    ...
    async def _perform_transactional_mutation(
        ...
        await generic_crown_remover(
            context.domain_context, uow, progress_reporter, Milestone, args.ref_id
        )
