...
from jupiter.core.apps.projects.stats import ProjectStats
...
class Project(LeafEntity):
    ...
    publish_entity = OwnsAtMostOne(
        PublishEntity, owner=IsEntityLinkStd(NamedEntityTag.PROJECT.value)
    )
    ...
    def new_project(
        ...
        new_dependency_ref_ids = Project._check_dependencies(dependency_ref_ids)
    ...
    def update(
        ...
        new_dependency_ref_ids = Project._check_dependencies(
    ...
    def _check_dependencies(
        ...
        """Normalise the projects this one depends on, dropping duplicates."""
