...
import type { ProjectParent } from "#/core/apps/projects/root";
import type { TopLevelInfo } from "#/core/infra/top-level-context";
import type { ProjectShowOptions } from "#/core/apps/projects/component/card";
import { ProjectCard } from "#/core/apps/projects/component/card";
      ...
      {props.projects.map((entry) => {
        return (
          <ProjectCard
            ...
            project={entry}
            projectMilestones={props.projectMilestonesByRefId?.get(
              entry.ref_id,
            )}
            projectStats={props.projectStatsByRefId?.get(entry.ref_id)}
