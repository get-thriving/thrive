...
from jupiter.core.apps.projects.service.archive import (
...
@use_case_args
class ProjectArchiveArgs(JupiterArchiveCrownEntityArgs):
    """PersonFindArgs."""
...
class ProjectArchiveUseCase(JupiterArchiveCrownEntityUseCase[ProjectArchiveArgs, None]):
    """The command for archiving a project."""
