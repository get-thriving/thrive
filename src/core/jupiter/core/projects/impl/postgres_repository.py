"""The PostgreSQL repository for projects."""
...
class PostgresProjectRepository(
    PostgresLeafEntityRepository[Project], ProjectRepository
):
...
class PostgresProjectStatsRepository(
    PostgresRecordRepository[ProjectStats, EntityId], ProjectStatsRepository
):
...
class PostgresProjectMilestoneRepository(
    PostgresLeafEntityRepository[ProjectMilestone], ProjectMilestoneRepository
):
