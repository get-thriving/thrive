...
import { ProjectStatusBigTag } from "#/core/projects/component/status-big-tag";
import { ProjectDonePctBigTag } from "#/core/projects/component/done-pct-big-tag";
  ...
  if (props.showLinkToProject) {
    actions.push(
      NavSingle({
        text: "Project",
        icon: <LaunchIcon />,
        link: `/app/workspace/projects/${props.bigPlan.ref_id}`,
      }),
    );
  }
  actions.push(
    ...
    >
      <Stack spacing={2} useFlexGap>
        ...
        <Stack direction="row" spacing={2}>
          <FormControl sx={{ flexGrow: 1 }}>
            <ProjectStatusBigTag status={props.bigPlan.status} />
            <input
              type="hidden"
      ...
      <CardActions sx={{ paddingLeft: "0px", paddingRight: "0px" }}>
        <Stack direction="column" spacing={1} sx={{ width: "100%" }}>
          {props.bigPlan.status === ProjectStatus.NOT_STARTED && (
          ...
          {props.bigPlan.status === ProjectStatus.IN_PROGRESS && (
            <ButtonGroup fullWidth>
              <Button
                size="small"
                variant="contained"
          ...
          {props.bigPlan.status === ProjectStatus.BLOCKED && (
            <ButtonGroup fullWidth>
              <Button
                size="small"
                variant="contained"
          ...
          {(props.bigPlan.status === ProjectStatus.DONE ||
            props.bigPlan.status === ProjectStatus.NOT_DONE) && (
            <ButtonGroup fullWidth>
              <Button
                size="small"
                variant="outlined"
