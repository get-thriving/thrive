"""PostgreSQL implementation of stats infra classes."""
...
class PostgresStatsLogEntryRepository(
    PostgresLeafEntityRepository[StatsLogEntry], StatsLogEntryRepository
):
    """Postgres implementation of the stats log entry repository."""
