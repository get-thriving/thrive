...
type StandardLinkComponent = React.ComponentType<
  StyledLinkProps & LinkProps & { children: React.ReactNode }
>;

export const StandardLink: StandardLinkComponent = styled(
  Link,
...
type FakeLinkComponent = React.ComponentType<
  StyledLinkProps &
    ComponentPropsWithoutRef<"span"> & { children: React.ReactNode }
>;
