...
class PostgresBigPlanStatsRepository(
    PostgresRecordRepository[BigPlanStats, EntityId], BigPlanStatsRepository
):
...
class PostgresBigPlanMilestoneRepository(
    PostgresLeafEntityRepository[BigPlanMilestone], BigPlanMilestoneRepository
):
