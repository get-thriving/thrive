...
@use_case_args
class CircleUpdateArgs(UseCaseArgsBase):
    """Circle update args."""
...
class CircleUpdateUseCase(
    JupiterTransactionalLoggedInMutationUseCase[CircleUpdateArgs, None]
):
    ...
    async def _perform_transactional_mutation(
        ...
        circle = await uow.get_for(Circle).load_by_id(args.ref_id)
