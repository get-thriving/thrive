"""PostgreSQL persistence for :class:`SearchEntityIndexingRecordRepository`."""
...
class PostgresSearchEntityIndexingRecordRepository(
    PostgresRecordRepository[
        SearchEntityIndexingRecord, tuple[EntityId, str, EntityId]
    ],
    SearchEntityIndexingRecordRepository,
):
