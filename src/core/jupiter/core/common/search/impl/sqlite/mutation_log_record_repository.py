"""SQLite persistence for :class:`SearchMutationLogRecordRepository`."""

from sqlite3 import IntegrityError
from typing import Final, cast

from jupiter.core.common.search.mutation_log_record import (
    SearchMutationLogRecord,
    SearchMutationLogRecordRepository,
)
from jupiter.core.common.search.mutation_log_status import SearchMutationLogStatus
...
class SqliteSearchMutationLogRecordRepository(
    SqliteRecordRepository[SearchMutationLogRecord, MutationId],
    SearchMutationLogRecordRepository,
):
    """SQLite table ``search_mutation_log``."""
