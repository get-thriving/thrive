...
import { SearchToolResults } from "#/core/common/search/components/search-tool-results";
...
const WORKSPACE_SEARCH_INSTANT_ROUTE = "/app/workspace/core/search-instant";
