...
@use_case_args
class LocationRemoveArgs(JupiterRemoveLeafSupportEntityArgs):
    """LocationRemove args."""
...
@mutation_use_case()
class LocationRemoveUseCase(
    JupiterRemoveLeafSupportEntityUseCase[LocationRemoveArgs, None]
):
    """Use case for removing a location."""
    ...
    async def _perform_transactional_mutation(
        ...
        await uow.get_for(Location).remove(context.domain_context, args.ref_id)
