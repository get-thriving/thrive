...
@use_case_args
class TimeEventInDayBlockCreateForProjectArgs(JupiterCreateLeafSupportEntityArgs):
    """Args."""
...
@use_case_result
class TimeEventInDayBlockCreateForProjectResult(UseCaseResultBase):
    """Result."""
...
@mutation_use_case()
class TimeEventInDayBlockCreateForProjectUseCase(
    JupiterCreateLeafSupportEntityUseCase[
    ...
    async def _perform_transactional_mutation(
        ...
        args: TimeEventInDayBlockCreateForProjectArgs,
    ) -> TimeEventInDayBlockCreateForProjectResult:
        """Execute the command's action."""
        project, owner_workspace_ref_id = await self.load_owner_entity(
        ...
        new_time_event = TimeEventInDayBlock.new_time_event_for_project(
        ...
        return TimeEventInDayBlockCreateForProjectResult(new_time_event=new_time_event)
