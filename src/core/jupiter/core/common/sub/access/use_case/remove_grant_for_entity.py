...
@use_case_args
class RemoveGrantForEntityArgs(JupiterCreateCrownEntityArgs):
...
@use_case_result
class RemoveGrantForEntityResult(UseCaseResultBase):
    """RemoveGrantForEntity result."""

    access_grant_ref_id: EntityId


@mutation_use_case()
class RemoveGrantForEntityUseCase(
    JupiterCreateCrownEntityUseCase[
        RemoveGrantForEntityArgs, RemoveGrantForEntityResult
    ]
):
    """Use case for removing an access grant from a shared entity."""
