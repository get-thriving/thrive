...
export function schedulingParamsCreateArgs(
  ...
  return {
    ...
    scheduling_event_duration_mins: intOrUndefined(
      form.schedulingEventDurationMins,
    ),
    scheduling_event_count: intOrUndefined(form.schedulingEventCount),
  };
}
...
export function schedulingParamsUpdateArgs(
  ...
  return {
    ...
    scheduling_event_duration_mins: {
      should_change: true,
      value: intOrUndefined(form.schedulingEventDurationMins) ?? null,
    },
    scheduling_event_count: {
      should_change: true,
      value: intOrUndefined(form.schedulingEventCount) ?? null,
    },
  };
}
