"""PostgreSQL implementation of gamification task scores classes."""
...
class PostgresScoreLogRepository(
    PostgresTrunkEntityRepository[ScoreLog], ScoreLogRepository
):
...
class PostgresScoreLogEntryRepository(
    PostgresLeafEntityRepository[ScoreLogEntry], ScoreLogEntryRepository
):
    """Postgres implementation of the score log entry repository."""
...
class PostgresScoreStatsRepository(
    PostgresRecordRepository[
        ScoreStats, tuple[EntityId, RecurringTaskPeriod | None, str]
    ],
    ScoreStatsRepository,
):
    """Postgres implementation of the score stats repository."""
...
class PostgresScorePeriodBestRepository(
    PostgresRecordRepository[
        ScorePeriodBest,
    ...
    """Postgres implementation of the score period best repository."""
