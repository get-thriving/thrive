"""PostgreSQL implementation of garbage collection infra classes."""

from jupiter.core.gc.log_entry import (
    GCLogEntry,
...
class PostgresGCLogEntryRepository(
    PostgresLeafEntityRepository[GCLogEntry], GCLogEntryRepository
):
    """Postgres implementation of the GC log entry repository."""
