...
@use_case_args
class ScheduleExportFindArgs(JupiterFindCrownEntityArgs):
    """Args."""
...
class ScheduleExportFindUseCase(
    JupiterFindCrownEntityUseCase[ScheduleExportFindArgs, ScheduleExportFindResult]
):
    """Usecase for finding schedule exports."""
    ...
    async def _perform_transactional_read(
        ...
        schedule_exports = await self.find_all_entities(
            uow,
            context.user.ref_id,
            ScheduleExport,
