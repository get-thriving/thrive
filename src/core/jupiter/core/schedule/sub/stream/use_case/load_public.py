"""Guest readonly use case for loading a published schedule stream."""
...
@use_case_args
class ScheduleStreamLoadPublicArgs(UseCaseArgsBase):
    """ScheduleStreamLoadPublic args."""

    external_id: PublishExternalId


class ScheduleStreamLoadPublicUseCase(
    JupiterGuestReadonlyUseCase[ScheduleStreamLoadPublicArgs, ScheduleStreamLoadResult]
):
    ...
    async def _execute(
        ...
        args: ScheduleStreamLoadPublicArgs,
    ) -> ScheduleStreamLoadResult:
