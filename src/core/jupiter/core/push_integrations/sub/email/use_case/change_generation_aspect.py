"""Update the email tasks generation aspect."""
...
@use_case_args
class EmailTaskChangeGenerationAspectArgs(UseCaseArgsBase):
    """PersonFindArgs."""
...
class EmailTaskChangeGenerationAspectUseCase(
    JupiterTransactionalLoggedInMutationUseCase[
        EmailTaskChangeGenerationAspectArgs, None
    ],
):
    ...
    async def _perform_transactional_mutation(
        ...
        args: EmailTaskChangeGenerationAspectArgs,
    ) -> None:
        ...
        old_generation_aspect_ref_id = email_task_collection.generation_aspect_ref_id
