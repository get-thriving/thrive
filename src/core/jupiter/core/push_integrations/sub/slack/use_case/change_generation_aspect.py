"""Update the slack tasks generation aspect."""
...
@use_case_args
class SlackTaskChangeGenerationAspectArgs(UseCaseArgsBase):
    """PersonFindArgs."""
...
class SlackTaskChangeGenerationAspectUseCase(
    JupiterTransactionalLoggedInMutationUseCase[
        SlackTaskChangeGenerationAspectArgs, None
    ],
):
    ...
    async def _perform_transactional_mutation(
        ...
        args: SlackTaskChangeGenerationAspectArgs,
    ) -> None:
        ...
        old_generation_aspect_ref_id = slack_task_collection.generation_aspect_ref_id

        await uow.get_for(Aspect).load_by_id(
            args.generation_aspect_ref_id,
        )
        ...
        if (
            old_generation_aspect_ref_id != args.generation_aspect_ref_id
            ...
            for inbox_task in all_generated_inbox_tasks:
                ...
                update_inbox_task = inbox_task.update_link_to_slack_task(
                    ...
                    aspect_ref_id=args.generation_aspect_ref_id,
        ...
        slack_task_collection = slack_task_collection.change_generation_aspect(
            ctx=context.domain_context,
            generation_aspect_ref_id=args.generation_aspect_ref_id,
        )
