"""Initial PostgreSQL schema (parallel to SQLite initial reset).
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "inbox_task" (
            ...
            actionable_date TIMESTAMP WITH TIME ZONE,
            due_date TIMESTAMP WITH TIME ZONE,
            recurring_timeline VARCHAR,
            recurring_repeat_index INTEGER,
            recurring_gen_right_now TIMESTAMP WITH TIME ZONE,
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "journal_collection" (
            ...
            writing_task_gen_params JSONB,
            archival_reason VARCHAR,
            generation_approach VARCHAR,
            generation_in_advance_days JSONB,
            PRIMARY KEY (ref_id),
            FOREIGN KEY (workspace_ref_id) REFERENCES workspace (ref_id)
        )
    """
    ...
    op.execute(
        ...
        CREATE TABLE gen_log_entry (
            ...
            period JSONB,
            filter_aspect_ref_ids JSONB,
            filter_habit_ref_ids JSONB,
            filter_chore_ref_ids JSONB,
            filter_metric_ref_ids JSONB,
            filter_person_ref_ids JSONB,
            filter_slack_task_ref_ids JSONB,
            filter_email_task_ref_ids JSONB,
            opened BOOLEAN NOT NULL,
            entity_created_records JSONB NOT NULL,
            entity_updated_records JSONB NOT NULL,
            entity_removed_records JSONB NOT NULL,
            name VARCHAR,
            archival_reason VARCHAR,
            PRIMARY KEY (ref_id),
    ...
    op.execute(
        ...
        CREATE TABLE stats_log_entry (
            ...
            today DATE NOT NULL,
            filter_habit_ref_ids JSONB,
            filter_project_ref_ids JSONB,
            filter_journal_ref_ids JSONB,
            entity_records JSONB NOT NULL,
            opened BOOLEAN NOT NULL,
            PRIMARY KEY (ref_id),
    ...
    op.execute(
        ...
        CREATE TABLE home_tab (
            ref_id INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
            version INTEGER NOT NULL,
            archived BOOLEAN NOT NULL,
            archival_reason VARCHAR,
            created_time TIMESTAMP WITH TIME ZONE NOT NULL,
            ...
            icon VARCHAR(64),
            widget_placement JSONB NOT NULL,
    ...
    op.execute(
        ...
        CREATE UNIQUE INDEX ix_vision_life_plan_ref_id_draft ON vision (life_plan_ref_id)
            Where archived=false AND status='draft'
    """
    )
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "chore" (
            ...
            start_at_date TIMESTAMP WITH TIME ZONE NOT NULL,
            end_at_date TIMESTAMP WITH TIME ZONE,
            gen_params JSONB,
            archival_reason VARCHAR,
            is_key BOOLEAN NOT NULL,
            chapter_ref_id INTEGER,
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "time_plan_domain" (
            ...
            generation_approach VARCHAR,
            generation_in_advance_days JSONB,
            planning_task_gen_params JSONB,
            PRIMARY KEY (ref_id),
    ...
    op.execute(
        ...
        CREATE TABLE schedule_export (
            ...
            name VARCHAR(255) NOT NULL,
            schedule_stream_ref_ids JSONB NOT NULL,
            PRIMARY KEY (ref_id),
            FOREIGN KEY (schedule_domain_ref_id) REFERENCES schedule_domain (ref_id)
        )
    """
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "contact_link" (
            ...
            name VARCHAR(255) NOT NULL,
            contact_domain_ref_id INTEGER NOT NULL,
            contacts_ref_ids JSONB NOT NULL,
            owner VARCHAR(256) NOT NULL,
            PRIMARY KEY (ref_id),
            FOREIGN KEY (contact_domain_ref_id) REFERENCES contact_domain (ref_id)
        )
    ...
    op.execute(
        ...
        CREATE TABLE IF NOT EXISTS "search_index" (
            ...
            parent_ref_id INTEGER NOT NULL,
            ...
            last_modified_time TIMESTAMP WITH TIME ZONE NOT NULL,
            archived_time TIMESTAMP WITH TIME ZONE,
            CONSTRAINT pk_search_index PRIMARY KEY (workspace_ref_id, entity_tag, ref_id),
            CONSTRAINT fk_search_index_workspace_ref_id FOREIGN KEY (workspace_ref_id)
                REFERENCES workspace (ref_id)
        )
    """
    )
    ...
    op.execute(
        """
        CREATE INDEX ix_search_index_name_trgm ON search_index USING gin (name gin_trgm_ops)
    """
    )

    op.execute(
        """
        CREATE INDEX ix_search_index_note_trgm ON search_index USING gin (note gin_trgm_ops)
    """
    )
