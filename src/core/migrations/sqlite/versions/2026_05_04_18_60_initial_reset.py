...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE project_collection (
            ...
            archived_time DATETIME,
            archival_reason VARCHAR,
            CONSTRAINT pk_project_collection PRIMARY KEY (ref_id),
    ...
    op.execute(
        """
        CREATE INDEX ix_project_collection_workspace_ref_id ON project_collection (workspace_ref_id)
    """
    )
    ...
    # -------------------------------------------------------------------------
    # Project (needs aspect, chapter, goal)
    # -------------------------------------------------------------------------
    op.execute(
        """
        CREATE TABLE IF NOT EXISTS "project" (
            ...
            goal_ref_id INTEGER,
            CONSTRAINT pk_project PRIMARY KEY (ref_id),
            CONSTRAINT fk_project_aspect_ref_id_aspect
                FOREIGN KEY (aspect_ref_id) REFERENCES aspect (ref_id),
            CONSTRAINT fk_project_project_collection_ref_id_project_collection
                FOREIGN KEY (project_collection_ref_id) REFERENCES project_collection (ref_id),
            CONSTRAINT fk_project_chapter_ref_id_chapter
                FOREIGN KEY (chapter_ref_id) REFERENCES chapter (ref_id),
            CONSTRAINT fk_project_goal_ref_id_goal
    ...
    op.execute(
        """
        CREATE INDEX ix_project_project_collection_ref_id ON project (project_collection_ref_id)
    """
    )

    op.execute(
        """
        CREATE INDEX ix_project_project_collection_ref_id_completed_time
            ON project (project_collection_ref_id, completed_time)
            WHERE completed_time IS NOT NULL
    """
    )
    ...
    op.execute(
        """
        CREATE INDEX ix_project_aspect_ref_id ON project (aspect_ref_id)
    """
    )

    op.execute(
        """
        CREATE INDEX ix_project_chapter_ref_id ON project (chapter_ref_id)
    """
    )

    op.execute(
        """
        CREATE INDEX ix_project_goal_ref_id ON project (goal_ref_id)
    """
    )
    ...
    op.execute(
        """
        CREATE INDEX ix_project_milestone_project_ref_id ON project_milestone (project_ref_id)
    """
    )

    op.execute(
        """
        CREATE UNIQUE INDEX ix_project_milestone_project_ref_id_date
            ON project_milestone (project_ref_id, date)
    """
    )
