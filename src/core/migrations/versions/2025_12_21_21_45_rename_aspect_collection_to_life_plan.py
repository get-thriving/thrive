"""'Rename aspect collection to life plan'
...
def upgrade() -> None:
    op.rename_table("aspect_collection", "life_plan")
    op.rename_table("aspect_collection_event", "life_plan_event")
    ...
    op.drop_index("ix_aspect_collection_workspace_ref_id")

    with op.batch_alter_table("aspect") as batch_op:
        batch_op.alter_column(
            "aspect_collection_ref_id", new_column_name="life_plan_ref_id"
        )
