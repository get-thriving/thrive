...
async def main() -> None:
    ...
    mcp_service = JupiterMcpService.build(
        ...
        JupiterMcpTool.tool("load-working-mem", "Load the current working memory", working_mem_load_current),
        JupiterMcpTool.tool("load-working-mem-settings", "Load working memory settings", working_mem_load_settings),
        JupiterMcpTool.tool("update-working-mem-settings", "Update working memory settings", working_mem_update_settings),
        # --- Time Plans ---
        ...
        JupiterMcpTool.tool("archive-time-plan", "Archive a time plan", time_plan_archive),
        JupiterMcpTool.tool("remove-time-plan", "Remove a time plan", time_plan_remove),
        JupiterMcpTool.tool("load-time-plan-for-date-and-period", "Load a time plan for a specific date and period", time_plan_load_for_date_and_period),
        JupiterMcpTool.tool("load-time-plan-settings", "Load time plan settings", time_plan_load_settings),
        JupiterMcpTool.tool("update-time-plan-settings", "Update time plan settings", time_plan_update_settings),
        JupiterMcpTool.tool("change-time-plan-time-config", "Change the time configuration of a time plan", time_plan_change_time_config),
        JupiterMcpTool.tool("associate-big-plan-with-time-plan", "Associate a big plan with a time plan", time_plan_associate_big_plan_with_plan),
        JupiterMcpTool.tool("associate-inbox-task-with-time-plan", "Associate an inbox task with a time plan", time_plan_associate_inbox_task_with_plan),
        JupiterMcpTool.tool("associate-time-plan-with-activities", "Associate a time plan with activities", time_plan_associate_with_activities),
        JupiterMcpTool.tool("associate-time-plan-with-big-plans", "Associate a time plan with big plans", time_plan_associate_with_big_plans),
        JupiterMcpTool.tool("associate-time-plan-with-inbox-tasks", "Associate a time plan with inbox tasks", time_plan_associate_with_inbox_tasks),
        # --- Time Plan Activities ---
        JupiterMcpTool.tool("find-time-plan-activity-for-target", "Find a time plan activity for a target", time_plan_activity_find_for_target),
        JupiterMcpTool.tool("load-time-plan-activity", "Load a time plan activity", time_plan_activity_load),
        JupiterMcpTool.tool("update-time-plan-activity", "Update a time plan activity", time_plan_activity_update),
        JupiterMcpTool.tool("archive-time-plan-activity", "Archive a time plan activity", time_plan_activity_archive),
        JupiterMcpTool.tool("remove-time-plan-activity", "Remove a time plan activity", time_plan_activity_remove),
        # --- Schedule Streams ---
        JupiterMcpResource.resource("jupiter://schedule/streams", schedule_stream_find),
        JupiterMcpTool.tool("find-schedule-streams", "Find schedule streams", schedule_stream_find),
        JupiterMcpTool.tool("create-schedule-stream-for-user", "Create a user schedule stream", schedule_stream_create_for_user),
        JupiterMcpTool.tool("create-schedule-stream-for-external-ical", "Create a schedule stream from an external iCal feed", schedule_stream_create_for_external_ical),
        JupiterMcpTool.tool("load-schedule-stream", "Load a schedule stream", schedule_stream_load),
        JupiterMcpTool.tool("update-schedule-stream", "Update a schedule stream", schedule_stream_update),
        JupiterMcpTool.tool("archive-schedule-stream", "Archive a schedule stream", schedule_stream_archive),
        JupiterMcpTool.tool("remove-schedule-stream", "Remove a schedule stream", schedule_stream_remove),
        # --- Schedule Events (Full Days) ---
        JupiterMcpTool.tool("create-schedule-event-full-days", "Create a full-day schedule event", schedule_event_full_days_create),
        JupiterMcpTool.tool("load-schedule-event-full-days", "Load a full-day schedule event", schedule_event_full_days_load),
        JupiterMcpTool.tool("update-schedule-event-full-days", "Update a full-day schedule event", schedule_event_full_days_update),
        JupiterMcpTool.tool("archive-schedule-event-full-days", "Archive a full-day schedule event", schedule_event_full_days_archive),
        JupiterMcpTool.tool("remove-schedule-event-full-days", "Remove a full-day schedule event", schedule_event_full_days_remove),
        JupiterMcpTool.tool("change-schedule-event-full-days-stream", "Change the stream of a full-day schedule event", schedule_event_full_days_change_schedule_stream),
        # --- Schedule Events (In Day) ---
        JupiterMcpTool.tool("create-schedule-event-in-day", "Create an in-day schedule event", schedule_event_in_day_create),
        JupiterMcpTool.tool("load-schedule-event-in-day", "Load an in-day schedule event", schedule_event_in_day_load),
        JupiterMcpTool.tool("update-schedule-event-in-day", "Update an in-day schedule event", schedule_event_in_day_update),
        JupiterMcpTool.tool("archive-schedule-event-in-day", "Archive an in-day schedule event", schedule_event_in_day_archive),
        JupiterMcpTool.tool("remove-schedule-event-in-day", "Remove an in-day schedule event", schedule_event_in_day_remove),
        JupiterMcpTool.tool("change-schedule-event-in-day-stream", "Change the stream of an in-day schedule event", schedule_event_in_day_change_schedule_stream),
        # --- Habits ---
        ...
        # --- Big Plan Milestones ---
        JupiterMcpTool.tool("create-big-plan-milestone", "Create a milestone for a big plan", big_plan_milestone_create),
        JupiterMcpTool.tool("load-big-plan-milestone", "Load a big plan milestone", big_plan_milestone_load),
        JupiterMcpTool.tool("update-big-plan-milestone", "Update a big plan milestone", big_plan_milestone_update),
        JupiterMcpTool.tool("archive-big-plan-milestone", "Archive a big plan milestone", big_plan_milestone_archive),
        JupiterMcpTool.tool("remove-big-plan-milestone", "Remove a big plan milestone", big_plan_milestone_remove),
        # --- Docs ---
        ...
        JupiterMcpTool.tool("load-journal-for-date-and-period", "Load a journal for a specific date and period", journal_load_for_date_and_period),
        JupiterMcpTool.tool("load-journal-settings", "Load journal settings", journal_load_settings),
        JupiterMcpTool.tool("update-journal-settings", "Update journal settings", journal_update_settings),
        JupiterMcpTool.tool("change-journal-time-config", "Change the time configuration of a journal", journal_change_time_config),
        # --- Life Plan ---
        JupiterMcpTool.tool("update-life-plan", "Update the life plan", life_plan_update),
        # --- Visions ---
        ...
        JupiterMcpTool.tool("create-vision-draft", "Create a draft vision", vision_create_draft),
        JupiterMcpTool.tool("load-vision", "Load a vision", vision_load),
        JupiterMcpTool.tool("load-active-vision", "Load the active vision", vision_load_active),
        ...
        JupiterMcpTool.tool("mark-vision-draft-as-active", "Mark a draft vision as active", vision_mark_draft_as_active),
        # --- Chapters ---
        ...
        JupiterMcpTool.tool("archive-milestone", "Archive a milestone", milestone_archive),
        JupiterMcpTool.tool("remove-milestone", "Remove a milestone", milestone_remove),
        # --- Projects ---
        JupiterMcpResource.resource("jupiter://life-plan/projects", project_find),
        ...
        JupiterMcpTool.tool("reorder-project-children", "Reorder children of a project", project_reorder_children),
        # --- Metrics ---
        ...
        JupiterMcpTool.tool("load-metric-settings", "Load metric settings", metric_load_settings),
        JupiterMcpTool.tool("change-metric-collection-project", "Change the collection project of a metric", metric_change_collection_project),
        # --- Metric Entries ---
        JupiterMcpTool.tool("create-metric-entry", "Create a metric entry", metric_entry_create),
        JupiterMcpTool.tool("load-metric-entry", "Load a metric entry", metric_entry_load),
        JupiterMcpTool.tool("update-metric-entry", "Update a metric entry", metric_entry_update),
        JupiterMcpTool.tool("archive-metric-entry", "Archive a metric entry", metric_entry_archive),
        JupiterMcpTool.tool("remove-metric-entry", "Remove a metric entry", metric_entry_remove),
        # --- PRM ---
        JupiterMcpTool.tool("load-person-settings", "Load PRM person settings", person_load_settings),
        JupiterMcpTool.tool("change-person-catch-up-project", "Change the catch-up project for persons", person_change_catch_up_project),
        # --- Persons ---
        ...
        # --- Occasions ---
        JupiterMcpTool.tool("create-occasion", "Create an occasion for a person", occasion_create),
        ...
        JupiterMcpTool.tool("archive-occasion", "Archive an occasion", occasion_archive),
        ...
        JupiterMcpTool.tool("create-smart-list", "Create a smart list", smart_list_create),
        JupiterMcpTool.tool("load-smart-list", "Load a smart list", smart_list_load),
        JupiterMcpTool.tool("update-smart-list", "Update a smart list", smart_list_update),
        JupiterMcpTool.tool("archive-smart-list", "Archive a smart list", smart_list_archive),
        JupiterMcpTool.tool("remove-smart-list", "Remove a smart list", smart_list_remove),
        # --- Smart List Items ---
        JupiterMcpTool.tool("create-smart-list-item", "Create a smart list item", smart_list_item_create),
        JupiterMcpTool.tool("load-smart-list-item", "Load a smart list item", smart_list_item_load),
        JupiterMcpTool.tool("update-smart-list-item", "Update a smart list item", smart_list_item_update),
        JupiterMcpTool.tool("archive-smart-list-item", "Archive a smart list item", smart_list_item_archive),
        JupiterMcpTool.tool("remove-smart-list-item", "Remove a smart list item", smart_list_item_remove),
        # --- Vacations ---
        ...
        JupiterMcpTool.tool("upsert-tag-link", "Create or update a tag link", tag_link_upsert),
        # --- Time Events ---
        JupiterMcpTool.tool("load-time-event-full-days-block", "Load a full-days time event block", time_event_full_days_block_load),
        JupiterMcpTool.tool("create-time-event-in-day-block-for-inbox-task", "Create an in-day time event block for an inbox task", time_event_in_day_block_create_for_inbox_task),
        JupiterMcpTool.tool("create-time-event-in-day-block-for-big-plan", "Create an in-day time event block for a big plan", time_event_in_day_block_create_for_big_plan),
        JupiterMcpTool.tool("load-time-event-in-day-block", "Load an in-day time event block", time_event_in_day_block_load),
        JupiterMcpTool.tool("update-time-event-in-day-block", "Update an in-day time event block", time_event_in_day_block_update),
        JupiterMcpTool.tool("archive-time-event-in-day-block", "Archive an in-day time event block", time_event_in_day_block_archive),
        JupiterMcpTool.tool("remove-time-event-in-day-block", "Remove an in-day time event block", time_event_in_day_block_remove),
    )
