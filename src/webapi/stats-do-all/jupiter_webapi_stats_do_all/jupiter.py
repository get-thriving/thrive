...
from jupiter.core.stats.use_case.do_all import StatsDoAllUseCase
...
import jupiter_webapi_stats_do_all.config
import jupiter_webapi_stats_do_all.exceptions
from jupiter_webapi_stats_do_all.config import (
...
async def main() -> None:
    ...
    cron_app_form = JupiterWebApiCronForm.build_from_module_root(
        ...
        telemetry,
        jupiter_webapi_stats_do_all.exceptions,
    )

    rich_print("=" * 80)
    rich_print("Starting Jupiter WebAPI cron (Stats do-all):")
