"""Exceptions handling for the Schedule external sync do-all WebAPI cron."""
...
from jupiter_webapi_schedule_external_sync_do_all.config import JupiterExceptionHandler
