...
from jupiter.core.apps.schedule.sub.external_sync_log.use_case.do_all import (
...
import jupiter_webapi_schedule_external_sync_do_all.config
import jupiter_webapi_schedule_external_sync_do_all.exceptions
from jupiter_webapi_schedule_external_sync_do_all.config import (
...
async def main() -> None:
    ...
    telemetry_deployment = TelemetryDeployment(
        service="schedule-external-sync-do-all",
