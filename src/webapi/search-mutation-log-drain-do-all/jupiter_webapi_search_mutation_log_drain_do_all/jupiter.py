...
import jupiter_webapi_search_mutation_log_drain_do_all.config
import jupiter_webapi_search_mutation_log_drain_do_all.exceptions
...
async def main() -> None:
    ...
    rich_print("=" * 80)
    rich_print("Starting Jupiter WebAPI cron (Search mutation log drain do-all):")
