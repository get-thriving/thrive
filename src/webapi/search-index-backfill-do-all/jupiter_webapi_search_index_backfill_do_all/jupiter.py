...
from jupiter.core.common.search.use_case.search_index_backfill_do_all import (
    SearchIndexBackfillDoAllUseCase,
)
...
import jupiter_webapi_search_index_backfill_do_all.config
import jupiter_webapi_search_index_backfill_do_all.exceptions
from jupiter_webapi_search_index_backfill_do_all.config import (
...
async def main() -> None:
    ...
    telemetry_deployment = TelemetryDeployment(
        service="search-index-backfill-do-all",
    ...
    cron_app_form = JupiterWebApiCronForm.build_from_module_root(
        ...
        telemetry,
        jupiter_webapi_search_index_backfill_do_all.exceptions,
    )

    rich_print("=" * 80)
    rich_print("Starting Jupiter WebAPI cron (Search index backfill do-all):")
