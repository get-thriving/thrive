...
export async function action({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const loginResult = await apiClient.application.loginLocal({
      email_address: form.emailAddress,
    ...
    return redirect(
      `/app/lifecycle/util/local/show-recovery-token?recoveryToken=${resetPasswordResult.new_recovery_token}`,
      {
        headers: {
