...
import { ProjectMilestoneStack } from "@jupiter/core/projects/sub/milestones/component/stack";
...
export default function Project() {
  ...
  return (
    <LeafPanel
      key={`project-${loaderData.bigPlan.ref_id}`}
      entityType={NamedEntityTag.PROJECT}
      entityRefId={loaderData.bigPlan.ref_id}
      fakeKey={`project-${loaderData.bigPlan.ref_id}`}
      ...
      <NestingAwareBlock shouldHide={shouldShowALeaflet}>
          ...
          actions={
            <SectionActions
              ...
              actions={[
                NavSingle({
                  text: "New",
                  link: `/app/workspace/projects/${loaderData.bigPlan.ref_id}/milestones/new`,
                }),
              ]}
            />
          }
          ...
          actions={
            <SectionActions
              ...
              actions={[
                NavSingle({
                  text: "New",
                  link: `/app/workspace/projects/${loaderData.bigPlan.ref_id}/inbox-tasks/new`,
                }),
                FilterFewOptionsCompact(
                  "View",
                    ...
                    {EISENS.map((e) => (
                      <Fragment key={e}>
                        ...
                        <InboxTaskKanbanBoard
                          ...
                          cardLinkResolver={(it) =>
                            `/app/workspace/projects/${loaderData.bigPlan.ref_id}/inbox-tasks/${it.ref_id}`
                          }
                        />
                      </Fragment>
                    ))}
        ...
        {isWorkspaceFeatureAvailable(
          ...
          <TimeEventInDayBlockStack
            ...
            inputsEnabled={inputsEnabled}
            title="Time Events"
            createLocation={`/app/workspace/calendar/time-event/in-day-block/new-for-project?bigPlanRefId=${loaderData.bigPlan.ref_id}`}
                ...
                <SectionActions
                  ...
                  actions={[
                    NavSingle({
                      text: "Add",
                      highlight: false,
                      link: `/app/workspace/time-plans/add-project-to-plans?bigPlanRefId=${loaderData.bigPlan.ref_id}`,
                    }),
                  ]}
                />
              }
