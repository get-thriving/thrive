  ...
  try {
    switch (form.intent) {
      case "add": {
        ...
        return redirect(`/app/workspace/chores/${query.choreRefId}`);
      }
...
export default function AddChoreToPlans() {
  ...
  return (
    <LeafPanel
      ...
      returnLocation={`/app/workspace/chores/${searchParams.get("choreRefId")}`}
...
export const ErrorBoundary = makeLeafErrorBoundary(
  (params, searchParams) =>
    `/app/workspace/chores/${searchParams.get("choreRefId")}`,
  ParamsSchema,
  {
    error: () =>
