  ...
  try {
    switch (form.intent) {
      case "add": {
        ...
        return redirect(`/app/workspace/habits/${query.habitRefId}`);
      }
...
export default function AddHabitToPlans() {
  ...
  return (
    <LeafPanel
      ...
      returnLocation={`/app/workspace/habits/${searchParams.get("habitRefId")}`}
...
export const ErrorBoundary = makeLeafErrorBoundary(
  (params, searchParams) =>
    `/app/workspace/habits/${searchParams.get("habitRefId")}`,
  ParamsSchema,
  {
    error: () =>
