...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const bigPlanResponse = await apiClient.bigPlans.bigPlanLoad({
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    await apiClient.timeEvents.timeEventInDayBlockCreateForBigPlan({
    ...
    switch (timePlanReason) {
      ...
      case "standard":
        return redirect(`/app/workspace/apps/big-plans/${query.bigPlanRefId}`);
    }
  } catch (error) {
...
export default function TimeEventInDayBlockCreateForBigPlan() {
