...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const projectResponse = await apiClient.projects.projectLoad({
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    await apiClient.timeEvents.timeEventInDayBlockCreateForProject({
...
export default function TimeEventInDayBlockCreateForProject() {
