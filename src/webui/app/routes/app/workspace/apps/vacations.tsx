...
export default function Vacations() {
  ...
  return (
    <TrunkPanel
      key={"vacations"}
      createLocation="/app/workspace/apps/vacations/new"
      ...
      <NestingAwareBlock shouldHide={shouldShowALeaf}>
        ...
        {sortedVacations.length === 0 && (
          <EntityNoNothingCard
            ...
            newEntityLocations="/app/workspace/apps/vacations/new"
          ...
          {sortedVacations.map((vacation) => {
            ...
            return (
              ...
              >
                ...
                <EntityLink
                  to={`/app/workspace/apps/vacations/${vacation.ref_id}`}
                >
...
function VacationCalendar({ today, sortedVacations }: VacationCalendarProps) {
  ...
  function handleDayClick(datum: TimeRangeDayData) {
    ...
    dayClickNavigate(`/app/workspace/apps/vacations/${theId}`);
  }
