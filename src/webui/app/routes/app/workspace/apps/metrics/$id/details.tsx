...
import { MetricDirectionSelect } from "@jupiter/core/apps/metrics/component/direction-select";
  ...
  try {
    switch (form.intent) {
      ...
      case "regen": {
        ...
        return redirect(`/app/workspace/apps/metrics/${id}/details`);
      }
      ...
      case "create-note": {
        ...
        return redirect(`/app/workspace/apps/metrics/${id}/archive`);
      }
...
export default function MetricDetails() {
  ...
  return (
    <LeafPanel
      ...
      returnLocation={`/app/workspace/apps/metrics/${id}`}
      accessable
