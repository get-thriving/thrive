...
import { allowUserChanges } from "@jupiter/core/apps/journals/source";
import { isWorkspaceFeatureAvailable } from "@jupiter/core/workspaces/root";
import { sortTimePlansNaturally } from "@jupiter/core/apps/time_plans/root";
...
import { JournalEditor } from "@jupiter/core/apps/journals/component/editor";
  ...
  try {
    switch (form.intent) {
      case "change-time-config": {
        ...
        return redirect(`/app/workspace/apps/journals/${id}`);
      }
      ...
      case "remove": {
        ...
        return redirect(`/app/workspace/apps/journals`);
      }
