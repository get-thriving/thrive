...
import { isRootAspect } from "#/core/apps/life_plan/sub/aspects/root";
import { EntityNoteEditor } from "@jupiter/core/infra/component/entity-note-editor";
import { makeLeafErrorBoundary } from "@jupiter/core/infra/component/error-boundary";
import { FieldError, GlobalError } from "@jupiter/core/infra/component/errors";
import { LeafPanel } from "@jupiter/core/infra/component/layout/leaf-panel";
import { AspectSelect } from "@jupiter/core/apps/life_plan/sub/aspects/component/select";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    switch (form.intent) {
      case "update": {
        const current = await apiClient.lifePlan.aspectLoad({
          ref_id: id,
          allow_archived: true,
        });
        const nextParentAspectRefId = form.parentAspectRefId ?? null;
        ...
        await apiClient.lifePlan.aspectUpdate({
          ...
          parent_aspect_ref_id: {
            should_change:
              nextParentAspectRefId !== current.aspect.parent_aspect_ref_id,
            value: nextParentAspectRefId,
          },
        });

        return redirect(`/app/workspace/apps/life-plan/aspects/${id}`);
      }
      ...
      case "archive": {
        ...
        return redirect(`/app/workspace/apps/life-plan/aspects`);
      }
