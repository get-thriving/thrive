...
import { BigPlanMilestoneSourceLink } from "@jupiter/core/apps/big_plans/sub/milestones/component/source-link";
import {
  ...
  try {
    switch (form.intent) {
      case "update": {
        ...
        return redirect(`/app/workspace/apps/big-plans/${bigPlanId}`);
      }
...
export default function BigPlanMilestoneView() {
  ...
  return (
    <LeafPanel
      ...
      returnLocation={`/app/workspace/apps/big-plans/${milestone.big_plan_ref_id}`}
    >
