...
export default function Habits() {
  ...
  const streakWidgetProps: WidgetProps = {
    ...
    habitStreak: {
      ...
      getNavUrl: (earliestDate: ADate, latestDate: ADate) => {
        return `/app/workspace/apps/habits?includeStreakMarksEarliestDate=${earliestDate}&includeStreakMarksLatestDate=${latestDate}`;
      },
    },
    geometry: {
      row: 0,
  ...
  return (
    <TrunkPanel
      key={"habits"}
      createLocation="/app/workspace/apps/habits/new"
...
function HabitRow(props: HabitRowProps) {
  ...
  return (
    ...
    >
      ...
      />
      <EntityLink to={`/app/workspace/apps/habits/${habit.ref_id}`}>
