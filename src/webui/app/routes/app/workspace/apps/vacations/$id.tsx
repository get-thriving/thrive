...
import { VacationEditor } from "@jupiter/core/apps/vacations/component/editor";
  ...
  try {
    switch (form.intent) {
      case "update": {
        ...
        return redirect(`/app/workspace/apps/vacations`);
      }
      ...
      case "create-note": {
        ...
        return redirect(`/app/workspace/apps/vacations/${id}`);
      }
