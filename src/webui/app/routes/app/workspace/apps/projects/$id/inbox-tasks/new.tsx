...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  const projectResult = await apiClient.projects.projectLoad({
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    ...
    const result = await apiClient.projects.projectCreateInboxTask({
    ...
    switch (timePlanReason) {
      case "for-time-plan":
        return redirect(
          withTimePlanView(
            `/app/workspace/apps/time-plans/${query.timePlanRefId}/${query.parentTimePlanActivityRefId}`,
      ...
      case "standard":
        return redirect(
          `/app/workspace/apps/projects/${projectId}/inbox-tasks/${result.new_inbox_task.ref_id}`,
        );
    }
  } catch (error) {
...
export default function ProjectNewInboxTask() {
  ...
  return (
    ...
    >
      ...
      <SectionCard
        title={`New Inbox Task for ${loaderData.project.name}`}
        ...
        actions={
          <SectionActions
            ...
            actions={[
              ...
              ActionSingle({
                id: "project-inbox-task-create-and-another",
                text: "Create & Another",
          ...
          <DateInputWithSuggestions
            ...
            defaultValue={
              loaderData.timePlanReason === "for-time-plan"
                ...
                : (loaderData.project.actionable_date ?? undefined)
            }
          ...
          <DateInputWithSuggestions
            ...
            defaultValue={
              loaderData.timePlanReason === "for-time-plan"
                ...
                : (loaderData.project.due_date ?? undefined)
            }
