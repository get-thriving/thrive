...
import { ProjectMultiSelect } from "@jupiter/core/apps/projects/component/multi-select";
import {
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    const result = await apiClient.projects.projectCreate({
      name: form.name,
      time_plan_ref_id:
    ...
    switch (timePlanReason) {
      case "standard":
        return redirect(
          `/app/workspace/apps/projects/${result.new_project.ref_id}`,
        );
