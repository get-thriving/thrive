...
import { InboxTaskStatusBigTag } from "@jupiter/core/common/sub/inbox_tasks/component/status-big-tag";
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  const { id: projectId, inboxTaskId } = parseParams(params, ParamsSchema);
...
export default function ProjectInboxTaskEdit() {
  ...
  return (
    <LeafPanel
      key={`project-inbox-task-${inboxTask.ref_id}`}
      isLeaflet
      fakeKey={`project-inbox-task-${inboxTask.ref_id}`}
    ...
    >
      ...
      <SectionCard
        ...
        actions={
          <SectionActions
            id="project-inbox-task-editor"
            topLevelInfo={topLevelInfo}
            inputsEnabled={inputsEnabled}
            actions={[
              ActionSingle({
                id: "project-inbox-task-editor-save",
                text: "Save",
                value: "update",
                highlight: true,
              }),
        ...
        <Stack spacing={2} useFlexGap>
          ...
          <Stack direction="row" useFlexGap spacing={1}>
            ...
            <FormControl fullWidth>
              <InputLabel id="project" shrink>
                Project
              </InputLabel>
              <OutlinedInput
                label="Project"
                readOnly
                value={loaderData.info.project?.name ?? "Unknown"}
              />
            </FormControl>
          </Stack>
