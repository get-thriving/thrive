        ...
        <ToolPanel>
          <SectionCard title="REST API">
            <Typography variant="body1">
              ...
              and scripts. Create an API key below, and follow the 
              instructions in the docs <DocsHelp size="small" subject={DocsHelpSubject.API} />.
            </Typography>
          ...
          >
            <EntityStack>
              {loaderData.apiKeys.map((apiKey) => (
                ...
                >
                  <EntityLink
                    to={`/app/workspace/manage-api/${apiKey.ref_id}`}
                  >
