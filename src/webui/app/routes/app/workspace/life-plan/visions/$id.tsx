import { ApiError, VisionStatus } from "@jupiter/webapi-client";
...
import { isVisionActivable, isVisionEditable } from "#/core/life_plan/sub/visions/root";
import { ActionSingle, SectionActions } from "#/core/infra/component/section-actions";
...
export default function Vision() {
  ...
  const noteInputsEnabled =
    inputsEabled && isVisionEditable(loaderData.vision);
