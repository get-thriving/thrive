...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react24.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react25.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react25.useState)(initial);
    (0, import_react25.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
// ../core/jupiter/core/infra/component/layout/trunk-panel.tsx
var import_react28 = __toESM(require_react(), 1);

// ../core/jupiter/core/infra/routes.ts
var TRUNK_ROUTE_MATCHER = /\/app\/workspace\/([^/]*)(\/.*)?/;
function extractTrunkFromPath(path) {
...
var STRICT_TRUNK_ROUTE_MATCHER = /\/app\/workspace\/([^/]*)/;
var BRANCH_ROUTE_MATCHER = /\/app\/workspace\/([^/]*)\/([^/]*)(\/.*)?/;
function extractBranchFromPath(path) {
...
// ../core/jupiter/core/infra/scroll-restoration.ts
function saveScrollPosition(ref, location) {
  window.sessionStorage.setItem(`scroll:${location}`, `${ref.scrollTop}`);
}
function restoreScrollPosition(ref, location) {
  ref.scrollTo(
    0,
...
// ../core/jupiter/core/infra/component/use-hidrated.ts
var import_react26 = __toESM(require_react(), 1);
function useHydrated() {
  const [hydrated, setHydrated] = (0, import_react26.useState)(false);
  (0, import_react26.useEffect)(() => setHydrated(true), []);
  return hydrated;
}
...
function TrunkPanel(props) {
  ...
  const handleScroll = (0, import_react28.useCallback)(
  ...
  return /* @__PURE__ */ jsxDEV(
    TrunkPanelFrame,
    {
      ...
      children: [
        !shouldShowABranch && (isBigScreen || !(shouldShowALeaf || shouldShowALeaflet)) && /* @__PURE__ */ jsxDEV(TrunkPanelControls, { id: "trunk-panel-controls", children: /* @__PURE__ */ jsxDEV(
            ...
            children: [
              /* @__PURE__ */ jsxDEV(ButtonGroup_default, { size: "small", children: [
                /* @__PURE__ */ jsxDEV(IconButton_default, { onClick: handleScrollTop, children: /* @__PURE__ */ jsxDEV(ArrowUpward_default, {}, void 0, false, {
                  fileName: "../core/jupiter/core/infra/component/layout/trunk-panel.tsx",
                  lineNumber: 166,
                  columnNumber: 19
                }, this) }, void 0, false, {
                  fileName: "../core/jupiter/core/infra/component/layout/trunk-panel.tsx",
              ...
              props.actions,
              /* @__PURE__ */ jsxDEV(IconButton_default, { sx: { marginLeft: "auto" }, children: /* @__PURE__ */ jsxDEV(Link, { to: props.returnLocation, children: /* @__PURE__ */ jsxDEV(Close_default, {}, void 0, false, {
                fileName: "../core/jupiter/core/infra/component/layout/trunk-panel.tsx",
                lineNumber: 188,
                columnNumber: 19
              }, this) }, void 0, false, {
...
var TrunkPanelFrame = styled_default(motion.div)(({ theme }) => ({
  backgroundColor: theme.palette.background.paper,
  width: "100vw"
}));
var TrunkPanelControls = styled_default("div")(
  ({ theme }) => `
      margin-bottom: 1rem;
      height: 3rem;
...
var TrunkPanelContent = styled_default("div")(
  ({ theme, isbigscreen, hasleaf, hasbranch }) => ({
    paddingTop: hasbranch === "false" ? isbigscreen === "true" ? "0.5rem" : "0px" : "0px",
    paddingBottom: hasbranch === "false" ? isbigscreen === "true" ? "0.5rem" : "0px" : "0px",
    paddingLeft: hasbranch === "false" ? isbigscreen === "true" ? `calc((100vw - ${theme.breakpoints.values.lg}px) / 2)` : "0.25rem" : "0px",
    paddingRight: hasbranch === "false" ? isbigscreen === "true" ? `calc((100vw - ${theme.breakpoints.values.lg}px) / 2)` : "0.25rem" : "0px",
    height: `calc(var(--vh, 1vh) * 100 - env(safe-area-inset-top) - ${isbigscreen === "true" ? "4rem" : "3.5rem"} - ${hasbranch === "false" ? isbigscreen === "true" ? "4rem" : hasleaf === "false" ? "4rem" : "0px" : "0px"})`,
    overflowY: "scroll"
  })
);
...
//# sourceMappingURL=/build/_shared/chunk-A6MOWSJE.js.map
