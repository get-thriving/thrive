...
// app/routes/app/workspace/calendar/time-event/in-day-block/new-for-chore.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/calendar/time-event/in-day-block/new-for-chore.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113141.0786";
}
var ParamsSchema = external_exports.object({});
var QuerySchema = external_exports.object({
  choreRefId: external_exports.string(),
...
function TimeEventInDayBlockCreateForChore() {
  _s();
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "time-event-in-day-block/new", returnLocation: `/app/workspace/calendar?${query}`, inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(TimeEventParamsSource, { startDate, startTimeInDay, durationMins }, void 0, false, {
      fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-chore.tsx",
      lineNumber: 156,
      columnNumber: 7
    }, this),
    ...
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "time-event-in-day-block-properties", title: "Properties", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "time-event-in-day-block-properties", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      ...
      /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
        ...
        /* @__PURE__ */ jsxDEV(OutlinedInput_default, { label: "name", name: "name", defaultValue: loaderData.chore.name, readOnly: true }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-chore.tsx",
          lineNumber: 167,
          columnNumber: 11
        }, this)
...
_s(TimeEventInDayBlockCreateForChore, "BV8Uh0/futcP2fjfG0INtQPX3No=", false, function() {
  return [useLoaderDataSafeForAnimation, useActionData, useNavigation, useSearchParams];
});
_c = TimeEventInDayBlockCreateForChore;
...
var _c2;
var _c3;
$RefreshReg$(_c, "TimeEventInDayBlockCreateForChore");
...
export {
  ErrorBoundary,
  TimeEventInDayBlockCreateForChore as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/calendar/time-event/in-day-block/new-for-chore-V777VRCP.js.map
