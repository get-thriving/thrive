...
// app/routes/app/workspace/manage-api/$id.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/manage-api/$id.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113167.4336";
}
...
function ApiKeyEdit() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: `manage-api/${apiKey.ref_id}`, returnLocation: "/app/workspace/manage-api", inputsEnabled, showArchiveButton: true, entityArchived: apiKey.archived, children: /* @__PURE__ */ jsxDEV(SectionCard, { title: `API Key: ${apiKey.name}`, actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: `api-key-${apiKey.ref_id}-actions`, topLevelInfo, inputsEnabled, actions: [ActionSingle({
    id: "api-key-update",
    text: "Save",
    value: "update",
    highlight: true
  })] }, void 0, false, {
    fileName: "app/routes/app/workspace/manage-api/$id.tsx",
    lineNumber: 129,
    columnNumber: 63
  }, this), children: [
    ...
    lineNumber: 129,
    columnNumber: 7
  }, this) }, `manage-api/${apiKey.ref_id}`, false, {
    fileName: "app/routes/app/workspace/manage-api/$id.tsx",
    lineNumber: 128,
    columnNumber: 10
  }, this);
...
//# sourceMappingURL=/build/routes/app/workspace/manage-api/$id-I72SUVCH.js.map
