...
// app/routes/app/workspace/manage-mcp/$id.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/manage-mcp/$id.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113157.1487";
}
...
function McpKeyEdit() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: `manage-mcp/${mcpKey.ref_id}`, returnLocation: "/app/workspace/manage-mcp", inputsEnabled, showArchiveButton: true, entityArchived: mcpKey.archived, children: /* @__PURE__ */ jsxDEV(SectionCard, { title: `MCP Key: ${mcpKey.name}`, actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: `mcp-key-${mcpKey.ref_id}-actions`, topLevelInfo, inputsEnabled, actions: [ActionSingle({
    id: "mcp-key-update",
    text: "Save",
    value: "update",
    highlight: true
  })] }, void 0, false, {
    fileName: "app/routes/app/workspace/manage-mcp/$id.tsx",
    lineNumber: 129,
    columnNumber: 63
  }, this), children: [
    ...
    lineNumber: 129,
    columnNumber: 7
  }, this) }, `manage-mcp/${mcpKey.ref_id}`, false, {
    fileName: "app/routes/app/workspace/manage-mcp/$id.tsx",
    lineNumber: 128,
    columnNumber: 10
  }, this);
...
_c = McpKeyEdit;
var ErrorBoundary = makeLeafErrorBoundary("/app/workspace/manage-mcp", ParamsSchema, {
...
//# sourceMappingURL=/build/routes/app/workspace/manage-mcp/$id-QF2CSSSB.js.map
