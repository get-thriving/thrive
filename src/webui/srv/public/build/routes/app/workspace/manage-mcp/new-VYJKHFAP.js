...
// app/routes/app/workspace/manage-mcp/new.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/manage-mcp/new.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113157.5254";
}
...
function NewMcpKey() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "manage-mcp/new", returnLocation: "/app/workspace/manage-mcp", inputsEnabled, children: /* @__PURE__ */ jsxDEV(SectionCard, { title: "New MCP Key", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "mcp-key-create", topLevelInfo, inputsEnabled, expansion: created ? 0 /* ALWAYS_SHOW */ : void 0, actions: created ? [ButtonSingle({
    ...
    text: "Close",
    link: "/app/workspace/manage-mcp"
  })] : [ActionSingle({
    text: "Create",
    value: "create",
    highlight: true
  })] }, void 0, false, {
    fileName: "app/routes/app/workspace/manage-mcp/new.tsx",
    lineNumber: 87,
    columnNumber: 49
  }, this), children: [
...
//# sourceMappingURL=/build/routes/app/workspace/manage-mcp/new-VYJKHFAP.js.map
