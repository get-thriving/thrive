...
// app/routes/app/workspace/calendar/time-event/in-day-block/new-for-time-plan-activity.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/calendar/time-event/in-day-block/new-for-time-plan-activity.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1777278937211.8333";
}
var ParamsSchema = external_exports.object({});
var QuerySchema = external_exports.object({
  timePlanActivityRefId: external_exports.string(),
  timePlanRefId: external_exports.string(),
...
function TimeEventInDayBlockCreateForTimePlanActivity() {
  _s();
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "time-event-in-day-block/new", returnLocation: `/app/workspace/calendar?${query}`, inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(TimeEventParamsSource, { startDate, startTimeInDay, durationMins }, void 0, false, {
      fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-time-plan-activity.tsx",
      lineNumber: 123,
      columnNumber: 7
    }, this),
    ...
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "time-event-in-day-block-properties", title: "Properties", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "time-event-in-day-block-properties", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      ...
      /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
        ...
        /* @__PURE__ */ jsxDEV(OutlinedInput_default, { label: "name", name: "name", defaultValue: loaderData.timePlanActivity.name, readOnly: true }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-time-plan-activity.tsx",
          lineNumber: 134,
          columnNumber: 11
        }, this)
...
_s(TimeEventInDayBlockCreateForTimePlanActivity, "BV8Uh0/futcP2fjfG0INtQPX3No=", false, function() {
  return [useLoaderDataSafeForAnimation, useActionData, useNavigation, useSearchParams];
});
_c = TimeEventInDayBlockCreateForTimePlanActivity;
...
var _c2;
var _c3;
$RefreshReg$(_c, "TimeEventInDayBlockCreateForTimePlanActivity");
...
export {
  ErrorBoundary,
  TimeEventInDayBlockCreateForTimePlanActivity as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/calendar/time-event/in-day-block/new-for-time-plan-activity-7AF5HVK4.js.map
