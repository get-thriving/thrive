...
// app/routes/app/workspace/calendar/schedule/stream/new-external.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/calendar/schedule/stream/new-external.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113135.6514";
}
var ParamsSchema = external_exports.object({});
var CreateFormSchema = external_exports.object({
  sourceIcalUrl: external_exports.string(),
...
function ScheduleStreamNew() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "schedule-stream/new", returnLocation: `/app/workspace/calendar/schedule/stream?${query}`, inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(GlobalError, { actionResult: actionData }, void 0, false, {
      fileName: "app/routes/app/workspace/calendar/schedule/stream/new-external.tsx",
      lineNumber: 77,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "schedule-stream-properties", title: "Properties", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "schedule-stream-properties", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      ...
      /* @__PURE__ */ jsxDEV(Typography_default, { variant: "body1", children: "In Google Calendar be sure to use the secret address in iCal format." }, void 0, false, {
        fileName: "app/routes/app/workspace/calendar/schedule/stream/new-external.tsx",
        lineNumber: 83,
        columnNumber: 9
      }, this),
      ...
      /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
        ...
        /* @__PURE__ */ jsxDEV(OutlinedInput_default, { label: "sourceIcalUrl", name: "sourceIcalUrl", readOnly: !inputsEnabled }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/schedule/stream/new-external.tsx",
          lineNumber: 89,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ jsxDEV(FieldError, { actionResult: actionData, fieldName: "/source_ical_url" }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/schedule/stream/new-external.tsx",
          lineNumber: 90,
          columnNumber: 11
        }, this)
...
//# sourceMappingURL=/build/routes/app/workspace/calendar/schedule/stream/new-external-NNJVKYA5.js.map
