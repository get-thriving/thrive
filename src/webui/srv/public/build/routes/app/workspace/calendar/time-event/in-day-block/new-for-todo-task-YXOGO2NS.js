...
// app/routes/app/workspace/calendar/time-event/in-day-block/new-for-todo-task.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/calendar/time-event/in-day-block/new-for-todo-task.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113140.2988";
}
var ParamsSchema = external_exports.object({});
var QuerySchema = external_exports.object({
  todoTaskRefId: external_exports.string(),
...
function TimeEventInDayBlockCreateForTodoTask() {
  _s();
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "time-event-in-day-block/new", returnLocation: `/app/workspace/calendar?${query}`, inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(TimeEventParamsSource, { startDate, startTimeInDay, durationMins }, void 0, false, {
      fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-todo-task.tsx",
      lineNumber: 156,
      columnNumber: 7
    }, this),
    ...
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "time-event-in-day-block-properties", title: "Properties", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "time-event-in-day-block-properties", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      ...
      /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
        ...
        /* @__PURE__ */ jsxDEV(OutlinedInput_default, { label: "name", name: "name", defaultValue: loaderData.todoTask.name, readOnly: true }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-todo-task.tsx",
          lineNumber: 167,
          columnNumber: 11
        }, this)
...
_s(TimeEventInDayBlockCreateForTodoTask, "BV8Uh0/futcP2fjfG0INtQPX3No=", false, function() {
  return [useLoaderDataSafeForAnimation, useActionData, useNavigation, useSearchParams];
});
_c = TimeEventInDayBlockCreateForTodoTask;
...
var _c2;
var _c3;
$RefreshReg$(_c, "TimeEventInDayBlockCreateForTodoTask");
...
export {
  ErrorBoundary,
  TimeEventInDayBlockCreateForTodoTask as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/calendar/time-event/in-day-block/new-for-todo-task-YXOGO2NS.js.map
