...
// app/routes/app/workspace/smart-lists/new.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/smart-lists/new.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113177.8694";
}
...
function NewSmartList() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "smart-lists/new", returnLocation: "/app/workspace/smart-lists", inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(GlobalError, { actionResult: actionData }, void 0, false, {
      fileName: "app/routes/app/workspace/smart-lists/new.tsx",
      lineNumber: 75,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ jsxDEV(SectionCard, { title: "New Smart List", actionsPosition: 1 /* BELOW */, actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "smart-list-create", topLevelInfo, inputsEnabled, actions: [ActionSingle({
  ...
  ] }, "smart-lists/new", true, {
    fileName: "app/routes/app/workspace/smart-lists/new.tsx",
    lineNumber: 74,
    columnNumber: 10
  }, this);
}
_s(NewSmartList, "G7puvUxUXA/5akLEuLt3IBDsrwc=", false, function() {
...
var _c;
$RefreshReg$(_c, "NewSmartList");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  ErrorBoundary,
  NewSmartList as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/smart-lists/new-6FS22YQT.js.map
