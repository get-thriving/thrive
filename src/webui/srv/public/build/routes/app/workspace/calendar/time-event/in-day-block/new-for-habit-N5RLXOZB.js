...
// app/routes/app/workspace/calendar/time-event/in-day-block/new-for-habit.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/calendar/time-event/in-day-block/new-for-habit.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113139.1858";
}
var ParamsSchema = external_exports.object({});
var QuerySchema = external_exports.object({
  habitRefId: external_exports.string(),
...
function TimeEventInDayBlockCreateForHabit() {
  _s();
  ...
  const inputsEnabled = navigation.state === "idle" && !loaderData.habit.archived;
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "time-event-in-day-block/new", returnLocation: `/app/workspace/calendar?${query}`, inputsEnabled, children: [
    /* @__PURE__ */ jsxDEV(TimeEventParamsSource, { startDate, startTimeInDay, durationMins }, void 0, false, {
      fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-habit.tsx",
      lineNumber: 156,
      columnNumber: 7
    }, this),
    ...
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "time-event-in-day-block-properties", title: "Properties", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "time-event-in-day-block-properties", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      ...
      /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
        ...
        /* @__PURE__ */ jsxDEV(OutlinedInput_default, { label: "name", name: "name", defaultValue: loaderData.habit.name, readOnly: true }, void 0, false, {
          fileName: "app/routes/app/workspace/calendar/time-event/in-day-block/new-for-habit.tsx",
          lineNumber: 167,
          columnNumber: 11
        }, this)
...
_s(TimeEventInDayBlockCreateForHabit, "BV8Uh0/futcP2fjfG0INtQPX3No=", false, function() {
  return [useLoaderDataSafeForAnimation, useActionData, useNavigation, useSearchParams];
});
_c = TimeEventInDayBlockCreateForHabit;
...
var _c2;
var _c3;
$RefreshReg$(_c, "TimeEventInDayBlockCreateForHabit");
...
export {
  ErrorBoundary,
  TimeEventInDayBlockCreateForHabit as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/calendar/time-event/in-day-block/new-for-habit-N5RLXOZB.js.map
