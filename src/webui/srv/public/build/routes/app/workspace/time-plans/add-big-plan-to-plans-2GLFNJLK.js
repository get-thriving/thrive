...
// app/routes/app/workspace/time-plans/add-big-plan-to-plans.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/time-plans/add-big-plan-to-plans.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1777213342609.3142";
}
...
function AddBigPlanToPlans() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: `add-big-plan-to-plans/${searchParams.get("bigPlanRefId")}`, returnLocation: `/app/workspace/big-plans/${searchParams.get("bigPlanRefId")}`, returnLocationDiscriminator: "add-big-plan-to-plans", inputsEnabled, initialExpansionState: "medium" /* MEDIUM */, children: [
    /* @__PURE__ */ jsxDEV(GlobalError, { actionResult: actionData }, void 0, false, {
      fileName: "app/routes/app/workspace/time-plans/add-big-plan-to-plans.tsx",
      lineNumber: 127,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ jsxDEV(SectionCard, { id: "add-big-plan-to-plans", title: "Add to Time Plans", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "add-big-plan-to-plans", topLevelInfo, inputsEnabled, actions: [ActionSingle({
      text: "Add",
      value: "add",
      highlight: true
    })] }, void 0, false, {
      ...
      /* @__PURE__ */ jsxDEV(TimePlanStack, { label: "Active Time Plans", topLevelInfo, timePlans: activeTimePlans, allowSelect: true, selectedPredicate: (timePlan) => targetTimePlanRefIds.has(timePlan.ref_id) || alreadyIncludedTimePlanRefIds.has(timePlan.ref_id), onClick: (timePlan) => {
  ...
  ] }, "add-big-plan-to-plans", true, {
    fileName: "app/routes/app/workspace/time-plans/add-big-plan-to-plans.tsx",
    lineNumber: 126,
    columnNumber: 10
  }, this);
}
_s(AddBigPlanToPlans, "xelVXcs1tJa4V7/14xSb6dwNdok=", false, function() {
  return [useLoaderDataSafeForAnimation, useActionData, useNavigation, useBigScreen, useSearchParams];
});
_c = AddBigPlanToPlans;
var ErrorBoundary = makeLeafErrorBoundary(_c2 = (params, searchParams) => `/app/workspace/big-plans/${searchParams.get("bigPlanRefId")}`, ParamsSchema, {
  error: () => `There was an error adding the big plan to time plans! Please try again!`
});
_c3 = ErrorBoundary;
...
var _c2;
var _c3;
$RefreshReg$(_c, "AddBigPlanToPlans");
...
export {
  ErrorBoundary,
  AddBigPlanToPlans as default,
  handle
};
//# sourceMappingURL=/build/routes/app/workspace/time-plans/add-big-plan-to-plans-2GLFNJLK.js.map
