...
// app/routes/app/workspace/manage-api/new.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/app/workspace/manage-api/new.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1775685113167.807";
}
...
function NewApiKey() {
  ...
  return /* @__PURE__ */ jsxDEV(LeafPanel, { fakeKey: "manage-api/new", returnLocation: "/app/workspace/manage-api", inputsEnabled, children: /* @__PURE__ */ jsxDEV(SectionCard, { title: "New API Key", actions: /* @__PURE__ */ jsxDEV(SectionActions, { id: "api-key-create", topLevelInfo, inputsEnabled, expansion: created ? 0 /* ALWAYS_SHOW */ : void 0, actions: created ? [ButtonSingle({
    ...
    fileName: "app/routes/app/workspace/manage-api/new.tsx",
    lineNumber: 87,
    columnNumber: 49
  }, this), children: [
    ...
    !created ? /* @__PURE__ */ jsxDEV(FormControl_default, { fullWidth: true, children: [
      ...
      lineNumber: 102,
      columnNumber: 21
    }, this) : apiKey ? /* @__PURE__ */ jsxDEV(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxDEV(ApiKeyBox, { variant: "body2", children: apiKey }, void 0, false, {
        fileName: "app/routes/app/workspace/manage-api/new.tsx",
        lineNumber: 111,
        columnNumber: 13
      }, this)
    ...
    lineNumber: 87,
    columnNumber: 7
  }, this) }, "manage-api/new", false, {
    fileName: "app/routes/app/workspace/manage-api/new.tsx",
    lineNumber: 86,
    columnNumber: 10
  }, this);
}
_s(NewApiKey, "nFJyqqooFWPgC9k8JEGnQBR9bRU=", false, function() {
  return [useActionData, useNavigation];
});
_c = NewApiKey;
var ErrorBoundary = makeLeafErrorBoundary("/app/workspace/manage-api", ParamsSchema, {
  error: () => `There was an error creating the API key! Please try again!`
});
var ApiKeyBox = styled_default(Typography_default)(({
  theme
}) => ({
  marginTop: "1rem",
  padding: "0.5rem",
...
var _c;
var _c2;
$RefreshReg$(_c, "NewApiKey");
$RefreshReg$(_c2, "ApiKeyBox");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  ErrorBoundary,
  NewApiKey as default,
  handle,
  shouldRevalidate
};
//# sourceMappingURL=/build/routes/app/workspace/manage-api/new-GUBZBOAN.js.map
