...
T = TypeVar("T", bound="CancelAccessInviteResult")


@_attrs_define
class CancelAccessInviteResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_access_invite_result = cls(
            access_invite_ref_id=access_invite_ref_id,
        )

        cancel_access_invite_result.additional_properties = d
        return cancel_access_invite_result
