...
T = TypeVar("T", bound="AcceptAccessToEntityResult")


@_attrs_define
class AcceptAccessToEntityResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accept_access_to_entity_result = cls(
            access_request_ref_id=access_request_ref_id,
        )

        accept_access_to_entity_result.additional_properties = d
        return accept_access_to_entity_result
