...
from ..models.vision_status import VisionStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="Vision")
...
class Vision:
    ...
    Attributes:
        ...
        status (VisionStatus): The status of a vision.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = VisionStatus(d.pop("status"))
        ...
        vision.additional_properties = d
        return vision
