...
class GCDoArgs:
    ...
    Attributes:
        gc_targets (list[SyncTarget] | None | Unset):
    """

    gc_targets: list[SyncTarget] | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        gc_targets: list[str] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_gc_targets(data: object) -> list[SyncTarget] | None | Unset:
            if data is None:
                return data
