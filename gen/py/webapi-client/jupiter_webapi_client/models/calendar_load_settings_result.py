...
T = TypeVar("T", bound="CalendarLoadSettingsResult")


@_attrs_define
class CalendarLoadSettingsResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_load_settings_result = cls(
            additional_timezones=additional_timezones,
        )

        calendar_load_settings_result.additional_properties = d
        return calendar_load_settings_result
