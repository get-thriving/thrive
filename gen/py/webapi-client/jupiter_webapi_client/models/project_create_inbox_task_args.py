...
T = TypeVar("T", bound="ProjectCreateInboxTaskArgs")


@_attrs_define
class ProjectCreateInboxTaskArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_create_inbox_task_args = cls(
            project_ref_id=project_ref_id,
            name=name,
            is_key=is_key,
            eisen=eisen,
        ...
        project_create_inbox_task_args.additional_properties = d
        return project_create_inbox_task_args
