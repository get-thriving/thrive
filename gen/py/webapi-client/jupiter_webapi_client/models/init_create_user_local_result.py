...
T = TypeVar("T", bound="InitCreateUserLocalResult")


@_attrs_define
class InitCreateUserLocalResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        init_create_user_local_result = cls(
            new_user=new_user,
            auth_token_ext=auth_token_ext,
        )

        init_create_user_local_result.additional_properties = d
        return init_create_user_local_result
