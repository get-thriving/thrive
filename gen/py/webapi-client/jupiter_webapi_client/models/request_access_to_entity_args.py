...
T = TypeVar("T", bound="RequestAccessToEntityArgs")


@_attrs_define
class RequestAccessToEntityArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_access_to_entity_args = cls(
            entity_type=entity_type,
            entity_ref_id=entity_ref_id,
            access_level=access_level,
        )

        request_access_to_entity_args.additional_properties = d
        return request_access_to_entity_args
