...
T = TypeVar("T", bound="APIKeyFindResult")


@_attrs_define
class APIKeyFindResult:
    """APIKeyFind result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for api_keys_item_data in _api_keys:
            api_keys_item = APIKeySummary.from_dict(api_keys_item_data)

            api_keys.append(api_keys_item)

        api_key_find_result = cls(
            api_keys=api_keys,
        )

        api_key_find_result.additional_properties = d
        return api_key_find_result
