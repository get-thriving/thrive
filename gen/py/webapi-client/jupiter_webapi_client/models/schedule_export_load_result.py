...
T = TypeVar("T", bound="ScheduleExportLoadResult")


@_attrs_define
class ScheduleExportLoadResult:
    """Result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_export_load_result = cls(
            schedule_export=schedule_export,
            tags=tags,
            note=note,
        )

        schedule_export_load_result.additional_properties = d
        return schedule_export_load_result
