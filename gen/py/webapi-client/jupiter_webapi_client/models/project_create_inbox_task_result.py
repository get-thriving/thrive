...
T = TypeVar("T", bound="ProjectCreateInboxTaskResult")


@_attrs_define
class ProjectCreateInboxTaskResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_create_inbox_task_result = cls(
            new_inbox_task=new_inbox_task,
            new_time_plan_activity=new_time_plan_activity,
        )

        project_create_inbox_task_result.additional_properties = d
        return project_create_inbox_task_result
