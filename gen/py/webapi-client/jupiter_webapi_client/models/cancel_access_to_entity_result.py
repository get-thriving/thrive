...
T = TypeVar("T", bound="CancelAccessToEntityResult")


@_attrs_define
class CancelAccessToEntityResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_access_to_entity_result = cls(
            access_request_ref_id=access_request_ref_id,
        )

        cancel_access_to_entity_result.additional_properties = d
        return cancel_access_to_entity_result
