...
class TimePlanUpdateSettingsArgsGenerationApproach:
    ...
    Attributes:
        should_change (bool):
        value (TimePlanGenerationApproach | Unset): The approach to generate time plans.
    """

    should_change: bool
    value: TimePlanGenerationApproach | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: TimePlanGenerationApproach | Unset
