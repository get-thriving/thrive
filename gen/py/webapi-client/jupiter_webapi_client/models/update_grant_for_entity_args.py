...
T = TypeVar("T", bound="UpdateGrantForEntityArgs")


@_attrs_define
class UpdateGrantForEntityArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_grant_for_entity_args = cls(
            entity_type=entity_type,
            entity_ref_id=entity_ref_id,
            access_grant_ref_id=access_grant_ref_id,
            access_level=access_level,
        ...
        update_grant_for_entity_args.additional_properties = d
        return update_grant_for_entity_args
