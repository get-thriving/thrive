...
if TYPE_CHECKING:
    from ..models.project_work_summary import ProjectWorkSummary
...
class PerProjectBreakdownItem:
    ...
    Attributes:
        ...
        summary (ProjectWorkSummary): The report for a project.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary = ProjectWorkSummary.from_dict(d.pop("summary"))
