...
T = TypeVar("T", bound="RequestAccessToEntityResult")


@_attrs_define
class RequestAccessToEntityResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_access_to_entity_result = cls(
            access_request_ref_id=access_request_ref_id,
        )

        request_access_to_entity_result.additional_properties = d
        return request_access_to_entity_result
