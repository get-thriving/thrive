...
T = TypeVar("T", bound="DocsFindSharedArgs")


@_attrs_define
class DocsFindSharedArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        docs_find_shared_args = cls(
            allow_archived=allow_archived,
        )

        docs_find_shared_args.additional_properties = d
        return docs_find_shared_args
