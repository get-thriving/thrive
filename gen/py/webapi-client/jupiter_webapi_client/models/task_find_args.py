...
T = TypeVar("T", bound="TaskFindArgs")
...
class TaskFindArgs:
    ...
    Attributes:
        ...
        filter_namespace (list[TaskNamespace] | None | Unset):
        filter_ref_ids (list[str] | None | Unset):
    """

    allow_archived: bool | None | Unset = UNSET
    filter_namespace: list[TaskNamespace] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_filter_namespace(data: object) -> list[TaskNamespace] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for filter_namespace_type_0_item_data in _filter_namespace_type_0:
                    filter_namespace_type_0_item = TaskNamespace(filter_namespace_type_0_item_data)
                ...
                pass
            return cast(list[TaskNamespace] | None | Unset, data)
        ...
        task_find_args.additional_properties = d
        return task_find_args
