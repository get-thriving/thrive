...
T = TypeVar("T", bound="TimePlanAssociateProjectWithPlanArgs")


@_attrs_define
class TimePlanAssociateProjectWithPlanArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_project_with_plan_args = cls(
            project_ref_id=project_ref_id,
            time_plan_ref_ids=time_plan_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_project_with_plan_args.additional_properties = d
        return time_plan_associate_project_with_plan_args
