...
if TYPE_CHECKING:
    ...
    from ..models.project_update_args_dependency_ref_ids import ProjectUpdateArgsDependencyRefIds
...
class ProjectUpdateArgs:
    ...
    Attributes:
        ...
        dependency_ref_ids (ProjectUpdateArgsDependencyRefIds):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dependency_ref_ids = ProjectUpdateArgsDependencyRefIds.from_dict(d.pop("dependency_ref_ids"))
