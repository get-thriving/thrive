...
T = TypeVar("T", bound="LoadAccessGrantArgs")


@_attrs_define
class LoadAccessGrantArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_access_grant_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        load_access_grant_args.additional_properties = d
        return load_access_grant_args
