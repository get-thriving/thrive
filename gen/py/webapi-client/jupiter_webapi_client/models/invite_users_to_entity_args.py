...
class InviteUsersToEntityArgs:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        user_ref_ids = self.user_ref_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_ref_ids = cast(list[str], d.pop("user_ref_ids"))

        access_level = AccessLevel(d.pop("access_level"))

        invite_users_to_entity_args = cls(
            entity_type=entity_type,
            entity_ref_id=entity_ref_id,
            user_ref_ids=user_ref_ids,
            access_level=access_level,
        ...
        invite_users_to_entity_args.additional_properties = d
        return invite_users_to_entity_args
