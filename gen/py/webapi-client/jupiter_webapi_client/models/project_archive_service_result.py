...
T = TypeVar("T", bound="ProjectArchiveServiceResult")


@_attrs_define
class ProjectArchiveServiceResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_archive_service_result = cls(
            archived_inbox_tasks=archived_inbox_tasks,
        )

        project_archive_service_result.additional_properties = d
        return project_archive_service_result
