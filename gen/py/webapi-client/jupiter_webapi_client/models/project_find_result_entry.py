...
class ProjectFindResultEntry:
    ...
    stats: None | ProjectStats | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_stats(data: object) -> None | ProjectStats | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | ProjectStats | Unset, data)
