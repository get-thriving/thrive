...
T = TypeVar("T", bound="DocsFindSharedDocEntry")


@_attrs_define
class DocsFindSharedDocEntry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        docs_find_shared_doc_entry = cls(
            doc=doc,
            tags=tags,
            owner=owner,
            access_status=access_status,
        ...
        docs_find_shared_doc_entry.additional_properties = d
        return docs_find_shared_doc_entry
