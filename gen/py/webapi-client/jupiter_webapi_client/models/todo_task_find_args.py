...
T = TypeVar("T", bound="TodoTaskFindArgs")


@_attrs_define
class TodoTaskFindArgs:
    """TodoTaskFind args.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        include_contacts: bool | None | Unset
        if isinstance(self.include_contacts, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_include_contacts(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        todo_task_find_args.additional_properties = d
        return todo_task_find_args
