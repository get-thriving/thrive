...
T = TypeVar("T", bound="ChoreFindSuitableForTimePlanResultEntry")


@_attrs_define
class ChoreFindSuitableForTimePlanResultEntry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chore_find_suitable_for_time_plan_result_entry = cls(
            chore=chore,
            has_uncompleted_historical_inbox_tasks=has_uncompleted_historical_inbox_tasks,
            would_generate_in_time_plan=would_generate_in_time_plan,
            aspect=aspect,
        ...
        chore_find_suitable_for_time_plan_result_entry.additional_properties = d
        return chore_find_suitable_for_time_plan_result_entry
