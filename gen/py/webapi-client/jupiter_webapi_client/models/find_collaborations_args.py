...
T = TypeVar("T", bound="FindCollaborationsArgs")


@_attrs_define
class FindCollaborationsArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_collaborations_args = cls(
            allow_archived=allow_archived,
        )

        find_collaborations_args.additional_properties = d
        return find_collaborations_args
