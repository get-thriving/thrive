...
T = TypeVar("T", bound="ProjectMilestoneLoadArgs")


@_attrs_define
class ProjectMilestoneLoadArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_milestone_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        project_milestone_load_args.additional_properties = d
        return project_milestone_load_args
