...
T = TypeVar("T", bound="AccessRequestLoadArgs")


@_attrs_define
class AccessRequestLoadArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_request_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        access_request_load_args.additional_properties = d
        return access_request_load_args
