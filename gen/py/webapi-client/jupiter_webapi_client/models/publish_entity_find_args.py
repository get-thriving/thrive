...
T = TypeVar("T", bound="PublishEntityFindArgs")


@_attrs_define
class PublishEntityFindArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        publish_entity_find_args = cls(
            allow_archived=allow_archived,
            filter_ref_ids=filter_ref_ids,
        )

        publish_entity_find_args.additional_properties = d
        return publish_entity_find_args
