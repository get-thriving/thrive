...
T = TypeVar("T", bound="AcceptAccessToEntityArgs")


@_attrs_define
class AcceptAccessToEntityArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accept_access_to_entity_args = cls(
            access_request_ref_id=access_request_ref_id,
        )

        accept_access_to_entity_args.additional_properties = d
        return accept_access_to_entity_args
