...
T = TypeVar("T", bound="AccessInviteLoadArgs")


@_attrs_define
class AccessInviteLoadArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_invite_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        access_invite_load_args.additional_properties = d
        return access_invite_load_args
