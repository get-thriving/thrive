...
T = TypeVar("T", bound="ScheduleExportFindArgs")


@_attrs_define
class ScheduleExportFindArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_export_find_args.additional_properties = d
        return schedule_export_find_args
