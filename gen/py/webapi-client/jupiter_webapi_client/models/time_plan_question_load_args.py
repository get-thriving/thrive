...
T = TypeVar("T", bound="TimePlanQuestionLoadArgs")


@_attrs_define
class TimePlanQuestionLoadArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_question_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        time_plan_question_load_args.additional_properties = d
        return time_plan_question_load_args
