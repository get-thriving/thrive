...
from ..models.publish_entity_status import PublishEntityStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="PublishEntity")
...
class PublishEntity:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PublishEntityStatus(d.pop("status"))
        ...
        publish_entity.additional_properties = d
