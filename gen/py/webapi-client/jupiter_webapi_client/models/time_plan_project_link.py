...
T = TypeVar("T", bound="TimePlanProjectLink")


@_attrs_define
class TimePlanProjectLink:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_project_link.additional_properties = d
        return time_plan_project_link
