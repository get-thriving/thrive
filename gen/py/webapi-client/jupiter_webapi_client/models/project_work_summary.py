...
T = TypeVar("T", bound="ProjectWorkSummary")


@_attrs_define
class ProjectWorkSummary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_work_summary.additional_properties = d
        return project_work_summary
