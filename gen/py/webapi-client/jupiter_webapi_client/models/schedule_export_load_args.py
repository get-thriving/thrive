...
T = TypeVar("T", bound="ScheduleExportLoadArgs")


@_attrs_define
class ScheduleExportLoadArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_export_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        schedule_export_load_args.additional_properties = d
        return schedule_export_load_args
