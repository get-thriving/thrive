...
T = TypeVar("T", bound="TimePlanAssociateWithProjectsArgs")


@_attrs_define
class TimePlanAssociateWithProjectsArgs:
    """Args.

    Attributes:
        ref_id (str): A generic entity id.
        project_ref_ids (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_ref_ids = cast(list[str], d.pop("project_ref_ids"))
        ...
        time_plan_associate_with_projects_args = cls(
            ref_id=ref_id,
            project_ref_ids=project_ref_ids,
            override_existing_dates=override_existing_dates,
            kind=kind,
        ...
        time_plan_associate_with_projects_args.additional_properties = d
        return time_plan_associate_with_projects_args
