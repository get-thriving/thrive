...
T = TypeVar("T", bound="JournalQuestionReorderArgs")


@_attrs_define
class JournalQuestionReorderArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        journal_question_reorder_args = cls(
            period=period,
            order_of_questions=order_of_questions,
        )

        journal_question_reorder_args.additional_properties = d
        return journal_question_reorder_args
