...
class PersonLoadArgs:
    ...
    Attributes:
        ...
        birthday_task_retrieve_offset (int | None | Unset):
    """

    ref_id: str
    allow_archived: bool
    catch_up_task_retrieve_offset: int | None | Unset = UNSET
    birthday_task_retrieve_offset: int | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_birthday_task_retrieve_offset(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
