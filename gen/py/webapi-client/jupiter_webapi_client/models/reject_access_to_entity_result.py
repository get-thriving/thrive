...
T = TypeVar("T", bound="RejectAccessToEntityResult")


@_attrs_define
class RejectAccessToEntityResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reject_access_to_entity_result = cls(
            access_request_ref_id=access_request_ref_id,
        )

        reject_access_to_entity_result.additional_properties = d
        return reject_access_to_entity_result
