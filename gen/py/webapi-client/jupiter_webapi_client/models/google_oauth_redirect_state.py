...
T = TypeVar("T", bound="GoogleOauthRedirectState")


@_attrs_define
class GoogleOauthRedirectState:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_oauth_redirect_state = cls(
            nonce=nonce,
            callback_success_url=callback_success_url,
            callback_failure_url=callback_failure_url,
        )

        google_oauth_redirect_state.additional_properties = d
