...
T = TypeVar("T", bound="JournalQuestionLoadArgs")


@_attrs_define
class JournalQuestionLoadArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        journal_question_load_args = cls(
            ref_id=ref_id,
            allow_archived=allow_archived,
        )

        journal_question_load_args.additional_properties = d
        return journal_question_load_args
