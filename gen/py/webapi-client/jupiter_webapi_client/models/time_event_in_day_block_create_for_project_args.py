...
T = TypeVar("T", bound="TimeEventInDayBlockCreateForProjectArgs")


@_attrs_define
class TimeEventInDayBlockCreateForProjectArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_event_in_day_block_create_for_project_args = cls(
            project_ref_id=project_ref_id,
            start_date=start_date,
            start_time_in_day=start_time_in_day,
            duration_mins=duration_mins,
        ...
        time_event_in_day_block_create_for_project_args.additional_properties = d
        return time_event_in_day_block_create_for_project_args
