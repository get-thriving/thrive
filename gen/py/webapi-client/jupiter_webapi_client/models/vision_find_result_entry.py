...
T = TypeVar("T", bound="VisionFindResultEntry")


@_attrs_define
class VisionFindResultEntry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vision_find_result_entry = cls(
            vision=vision,
            note=note,
        )

        vision_find_result_entry.additional_properties = d
        return vision_find_result_entry
