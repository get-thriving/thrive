...
T = TypeVar("T", bound="AcknowledgeAccessInviteArgs")


@_attrs_define
class AcknowledgeAccessInviteArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acknowledge_access_invite_args = cls(
            access_invite_ref_id=access_invite_ref_id,
        )

        acknowledge_access_invite_args.additional_properties = d
        return acknowledge_access_invite_args
