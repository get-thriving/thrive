...
T = TypeVar("T", bound="CancelAccessInviteArgs")


@_attrs_define
class CancelAccessInviteArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_access_invite_args = cls(
            access_invite_ref_id=access_invite_ref_id,
        )

        cancel_access_invite_args.additional_properties = d
        return cancel_access_invite_args
