...
T = TypeVar("T", bound="BigPlanLoadPublicArgs")


@_attrs_define
class BigPlanLoadPublicArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        big_plan_load_public_args = cls(
            external_id=external_id,
            inbox_task_retrieve_offset=inbox_task_retrieve_offset,
        )

        big_plan_load_public_args.additional_properties = d
        return big_plan_load_public_args
