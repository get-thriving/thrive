...
T = TypeVar("T", bound="ProjectLoadPublicArgs")


@_attrs_define
class ProjectLoadPublicArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_load_public_args = cls(
            external_id=external_id,
            inbox_task_retrieve_offset=inbox_task_retrieve_offset,
        )

        project_load_public_args.additional_properties = d
        return project_load_public_args
