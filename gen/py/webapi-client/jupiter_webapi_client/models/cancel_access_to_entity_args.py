...
T = TypeVar("T", bound="CancelAccessToEntityArgs")


@_attrs_define
class CancelAccessToEntityArgs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_access_to_entity_args = cls(
            access_request_ref_id=access_request_ref_id,
        )

        cancel_access_to_entity_args.additional_properties = d
        return cancel_access_to_entity_args
