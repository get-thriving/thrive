...
def _get_kwargs(
    *,
    body: StatsLoadRunsArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | StatsLoadRunsResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | StatsLoadRunsResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (StatsLoadRunsArgs | Unset): StatsLoadRunsArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | StatsLoadRunsResult
    """
