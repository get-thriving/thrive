...
from ...models.smart_list_item_load_public_args import SmartListItemLoadPublicArgs
...
def _get_kwargs(
    *,
    body: SmartListItemLoadPublicArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListItemLoadPublicArgs | Unset): SmartListItemLoadPublic args.
