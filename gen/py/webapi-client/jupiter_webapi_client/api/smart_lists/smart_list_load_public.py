...
from ...models.smart_list_load_public_args import SmartListLoadPublicArgs
...
def _get_kwargs(
    *,
    body: SmartListLoadPublicArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListLoadPublicArgs | Unset): SmartListLoadPublic args.
