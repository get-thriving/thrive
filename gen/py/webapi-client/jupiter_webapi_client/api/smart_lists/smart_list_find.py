...
def _get_kwargs(
    *,
    body: SmartListFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | SmartListFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SmartListFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListFindArgs | Unset): SmartListFind args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | SmartListFindResult
    """
