...
def _get_kwargs(
    *,
    body: SmartListCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | SmartListCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SmartListCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListCreateArgs | Unset): SmartListCreate args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | SmartListCreateResult
    """
