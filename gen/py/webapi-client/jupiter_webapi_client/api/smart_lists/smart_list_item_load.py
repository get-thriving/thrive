...
def _get_kwargs(
    *,
    body: SmartListItemLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> Any | SmartListItemLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | SmartListItemLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListItemLoadArgs | Unset): SmartListItemLoadArgs.
