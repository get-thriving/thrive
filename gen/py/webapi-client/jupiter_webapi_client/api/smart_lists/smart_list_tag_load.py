...
def _get_kwargs(
    *,
    body: SmartListTagLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> Any | SmartListTagLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | SmartListTagLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (SmartListTagLoadArgs | Unset): SmartListTagLoadArgs.
