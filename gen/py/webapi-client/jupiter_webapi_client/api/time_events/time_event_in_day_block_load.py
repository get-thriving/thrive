...
def _get_kwargs(
    *,
    body: TimeEventInDayBlockLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimeEventInDayBlockLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimeEventInDayBlockLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimeEventInDayBlockLoadArgs | Unset): InDayBlockLoadArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimeEventInDayBlockLoadResult
    """
