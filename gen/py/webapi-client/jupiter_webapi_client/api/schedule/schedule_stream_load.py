...
def _get_kwargs(
    *,
    body: ScheduleStreamLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> Any | ScheduleStreamLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ScheduleStreamLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleStreamLoadArgs | Unset): Args.
