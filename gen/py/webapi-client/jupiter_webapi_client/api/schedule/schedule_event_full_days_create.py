...
def _get_kwargs(
    *,
    body: ScheduleEventFullDaysCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | ScheduleEventFullDaysCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ScheduleEventFullDaysCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleEventFullDaysCreateArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ScheduleEventFullDaysCreateResult
    """
