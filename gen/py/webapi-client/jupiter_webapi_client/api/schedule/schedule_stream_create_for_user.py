...
def _get_kwargs(
    *,
    body: ScheduleStreamCreateForUserArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | ScheduleStreamCreateForUserResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ScheduleStreamCreateForUserResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleStreamCreateForUserArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ScheduleStreamCreateForUserResult
    """
