...
def _get_kwargs(
    *,
    body: ScheduleEventInDayLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> Any | ScheduleEventInDayLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ScheduleEventInDayLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleEventInDayLoadArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        Any | ScheduleEventInDayLoadResult
    """
