...
from ...models.schedule_event_in_day_load_public_args import ScheduleEventInDayLoadPublicArgs
...
def _get_kwargs(
    *,
    body: ScheduleEventInDayLoadPublicArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleEventInDayLoadPublicArgs | Unset): ScheduleEventInDayLoadPublic args.
