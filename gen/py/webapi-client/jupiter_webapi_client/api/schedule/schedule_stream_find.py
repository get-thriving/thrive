...
def _get_kwargs(
    *,
    body: ScheduleStreamFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | ScheduleStreamFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ScheduleStreamFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ScheduleStreamFindArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ScheduleStreamFindResult
    """
