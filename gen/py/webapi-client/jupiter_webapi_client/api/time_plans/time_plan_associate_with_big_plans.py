...
def _get_kwargs(
    *,
    body: TimePlanAssociateWithBigPlansArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanAssociateWithBigPlansResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanAssociateWithBigPlansResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanAssociateWithBigPlansArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanAssociateWithBigPlansResult
    """
