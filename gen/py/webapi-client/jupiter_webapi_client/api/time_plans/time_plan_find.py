...
def _get_kwargs(
    *,
    body: TimePlanFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanFindArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanFindResult
    """
