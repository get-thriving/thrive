...
def _get_kwargs(
    *,
    body: TimePlanLoadForDateAndPeriodArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanLoadForDateAndPeriodResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanLoadForDateAndPeriodResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanLoadForDateAndPeriodArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanLoadForDateAndPeriodResult
    """
