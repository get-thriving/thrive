...
def _get_kwargs(
    *,
    body: TimePlanAssociateWithInboxTasksArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanAssociateWithInboxTasksResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanAssociateWithInboxTasksResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanAssociateWithInboxTasksArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanAssociateWithInboxTasksResult
    """
