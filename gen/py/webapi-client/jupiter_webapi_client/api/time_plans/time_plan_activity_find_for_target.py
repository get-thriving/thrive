...
def _get_kwargs(
    *,
    body: TimePlanActivityFindForTargetArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanActivityFindForTargetResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanActivityFindForTargetResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanActivityFindForTargetArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanActivityFindForTargetResult
    """
