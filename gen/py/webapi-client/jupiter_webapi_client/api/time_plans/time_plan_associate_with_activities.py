...
def _get_kwargs(
    *,
    body: TimePlanAssociateWithActivitiesArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanAssociateWithActivitiesResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanAssociateWithActivitiesResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanAssociateWithActivitiesArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanAssociateWithActivitiesResult
    """
