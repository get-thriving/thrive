...
def _get_kwargs(
    *,
    body: TimePlanCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanCreateArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanCreateResult
    """
