...
def _get_kwargs(
    *,
    body: TimePlanActivityLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | TimePlanActivityLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | TimePlanActivityLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (TimePlanActivityLoadArgs | Unset): TimePlanActivityLoadArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | TimePlanActivityLoadResult
    """
