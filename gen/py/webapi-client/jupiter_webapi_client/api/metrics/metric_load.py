...
def _get_kwargs(
    *,
    body: MetricLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | MetricLoadResult | None:
...
def sync_detailed(
    *,
    ...
    Args:
        body (MetricLoadArgs | Unset): MetricLoadArgs.
