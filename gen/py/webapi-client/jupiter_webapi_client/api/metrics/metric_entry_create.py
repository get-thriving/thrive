...
def _get_kwargs(
    *,
    body: MetricEntryCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | MetricEntryCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | MetricEntryCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (MetricEntryCreateArgs | Unset): MetricEntryCreate args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | MetricEntryCreateResult
    """
