...
from ...models.metric_entry_load_public_args import MetricEntryLoadPublicArgs
...
def _get_kwargs(
    *,
    body: MetricEntryLoadPublicArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (MetricEntryLoadPublicArgs | Unset): MetricEntryLoadPublic args.
