...
def _get_kwargs(
    *,
    body: HomeTabCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | HomeTabCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HomeTabCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (HomeTabCreateArgs | Unset): The arguments for the create home tab use case.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HomeTabCreateResult
    """
