...
def _get_kwargs(
    *,
    body: BigPlanFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> BigPlanFindResult | ErrorResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BigPlanFindResult | ErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (BigPlanFindArgs | Unset): PersonFindArgs.
...
def sync(
    *,
    ...
    Returns:
        BigPlanFindResult | ErrorResponse
    """
