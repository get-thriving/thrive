...
def _get_kwargs(
    *,
    body: BigPlanUpdateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> BigPlanUpdateResult | ErrorResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BigPlanUpdateResult | ErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (BigPlanUpdateArgs | Unset): PersonFindArgs.
...
def sync(
    *,
    ...
    Returns:
        BigPlanUpdateResult | ErrorResponse
    """
