...
def _get_kwargs(
    *,
    body: WorkingMemLoadCurrentArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | WorkingMemLoadCurrentResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | WorkingMemLoadCurrentResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (WorkingMemLoadCurrentArgs | Unset): Working mem find args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | WorkingMemLoadCurrentResult
    """
