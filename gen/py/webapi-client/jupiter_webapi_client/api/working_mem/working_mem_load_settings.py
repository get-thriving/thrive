...
def _get_kwargs(
    *,
    body: WorkingMemLoadSettingsArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | WorkingMemLoadSettingsResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | WorkingMemLoadSettingsResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (WorkingMemLoadSettingsArgs | Unset): WorkingMemLoadSettings args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | WorkingMemLoadSettingsResult
    """
