...
def _get_kwargs(
    *,
    body: HabitCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | HabitCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HabitCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (HabitCreateArgs | Unset): HabitCreate args..
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HabitCreateResult
    """
