...
def _get_kwargs(
    *,
    body: PersonCreateArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | PersonCreateResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | PersonCreateResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (PersonCreateArgs | Unset): Person create args..
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | PersonCreateResult
    """
