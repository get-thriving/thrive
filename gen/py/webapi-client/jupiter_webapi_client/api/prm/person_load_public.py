...
from ...models.person_load_public_args import PersonLoadPublicArgs
...
def _get_kwargs(
    *,
    body: PersonLoadPublicArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PersonLoadPublicArgs | Unset): PersonLoadPublic args.
