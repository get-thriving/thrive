...
def _get_kwargs(
    *,
    body: InboxTaskLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | InboxTaskLoadResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | InboxTaskLoadResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (InboxTaskLoadArgs | Unset): InboxTaskLoadArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | InboxTaskLoadResult
    """
