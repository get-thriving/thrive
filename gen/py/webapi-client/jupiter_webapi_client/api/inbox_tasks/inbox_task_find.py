...
def _get_kwargs(
    *,
    body: InboxTaskFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | InboxTaskFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | InboxTaskFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (InboxTaskFindArgs | Unset): PersonFindArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | InboxTaskFindResult
    """
