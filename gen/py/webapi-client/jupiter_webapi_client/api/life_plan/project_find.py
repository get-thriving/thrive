...
def _get_kwargs(
    *,
    body: ProjectFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | ProjectFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ProjectFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ProjectFindArgs | Unset): PersonFindArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ProjectFindResult
    """
