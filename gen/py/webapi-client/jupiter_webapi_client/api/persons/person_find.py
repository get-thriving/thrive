...
def _get_kwargs(
    *,
    body: PersonFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | PersonFindResult | None:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PersonFindArgs | Unset): PersonFindArgs.
