...
def _get_kwargs(
    *,
    body: SlackTaskLoadSettingsArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | SlackTaskLoadSettingsResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SlackTaskLoadSettingsResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (SlackTaskLoadSettingsArgs | Unset): SlackTaskLoadSettings args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | SlackTaskLoadSettingsResult
    """
