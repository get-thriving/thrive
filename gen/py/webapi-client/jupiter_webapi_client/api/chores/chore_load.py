...
def _get_kwargs(
    *,
    body: ChoreLoadArgs | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | ChoreLoadResult | None:
...
def sync_detailed(
    *,
    ...
    Args:
        body (ChoreLoadArgs | Unset): ChoreLoadArgs.
