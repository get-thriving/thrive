...
def _get_kwargs(
    *,
    body: JournalLoadSettingsArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | JournalLoadSettingsResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | JournalLoadSettingsResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (JournalLoadSettingsArgs | Unset): JournalLoadSettings args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | JournalLoadSettingsResult
    """
