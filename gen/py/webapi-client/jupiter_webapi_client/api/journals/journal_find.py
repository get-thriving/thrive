...
def _get_kwargs(
    *,
    body: JournalFindArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | JournalFindResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | JournalFindResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (JournalFindArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | JournalFindResult
    """
