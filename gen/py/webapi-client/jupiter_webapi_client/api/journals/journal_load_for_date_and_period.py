...
def _get_kwargs(
    *,
    body: JournalLoadForDateAndPeriodArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | JournalLoadForDateAndPeriodResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | JournalLoadForDateAndPeriodResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (JournalLoadForDateAndPeriodArgs | Unset): Args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | JournalLoadForDateAndPeriodResult
    """
