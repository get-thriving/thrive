...
def _get_kwargs(
    *,
    body: GetSummariesArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | GetSummariesResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GetSummariesResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (GetSummariesArgs | Unset): Get summaries args.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | GetSummariesResult
    """
