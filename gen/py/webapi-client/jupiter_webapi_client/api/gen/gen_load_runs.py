...
def _get_kwargs(
    *,
    body: GenLoadRunsArgs | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ErrorResponse | GenLoadRunsResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GenLoadRunsResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (GenLoadRunsArgs | Unset): GenLoadRunsArgs.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | GenLoadRunsResult
    """
