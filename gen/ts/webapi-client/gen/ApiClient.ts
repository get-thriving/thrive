...
export class ApiClient {
    ...
    public readonly useCase: UseCaseService;
    public readonly useCases: UseCasesService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.useCase = new UseCaseService(this.request);
        this.useCases = new UseCasesService(this.request);
