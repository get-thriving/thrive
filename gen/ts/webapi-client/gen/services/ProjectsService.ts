...
import type { ProjectLoadPublicArgs } from '../models/ProjectLoadPublicArgs';
...
export class ProjectsService {
     ...
     * @throws ApiError
     */
    public projectMilestoneArchive(
     ...
     * @throws ApiError
     */
    public projectLoadPublic(
        requestBody?: ProjectLoadPublicArgs,
    ): CancelablePromise<ProjectLoadResult> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/project-load-public',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Error response for EntityAlreadyExistsError`,
